...
80100048:	bb 18 c6 10 80       	mov    $0x8010c618,%ebx
{
8010004d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
80100050:	68 60 76 10 80       	push   $0x80107660
80100055:	68 e0 c5 10 80       	push   $0x8010c5e0
8010005a:	e8 c1 47 00 00       	call   80104820 <initlock>
  bcache.head.next = &bcache.head;
8010005f:	83 c4 10             	add    $0x10,%esp
80100062:	b8 58 0d 11 80       	mov    $0x80110d58,%eax
  bcache.head.prev = &bcache.head;
80100067:	c7 05 ac 0d 11 80 58 	movl   $0x80110d58,0x80110dac
8010006e:	0d 11 80 
  bcache.head.next = &bcache.head;
80100071:	c7 05 b0 0d 11 80 58 	movl   $0x80110d58,0x80110db0
80100078:	0d 11 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d b0 0d 11 80    	mov    %ebx,0x80110db0
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb f8 0a 11 80    	cmp    $0x80110af8,%ebx
...
801000e8:	e8 c3 48 00 00       	call   801049b0 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000ed:	8b 1d b0 0d 11 80    	mov    0x80110db0,%ebx
801000f3:	83 c4 10             	add    $0x10,%esp
801000f6:	81 fb 58 0d 11 80    	cmp    $0x80110d58,%ebx
...
801001c2:	e8 f9 45 00 00       	call   801047c0 <holdingsleep>
...
80100203:	e8 b8 45 00 00       	call   801047c0 <holdingsleep>
...
80100213:	e8 68 45 00 00       	call   80104780 <releasesleep>

  acquire(&bcache.lock);
80100218:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
8010021f:	e8 8c 47 00 00       	call   801049b0 <acquire>
  b->refcnt--;
...
80100243:	89 50 58             	mov    %edx,0x58(%eax)
    b->next = bcache.head.next;
80100246:	a1 b0 0d 11 80       	mov    0x80110db0,%eax
    b->prev = &bcache.head;
8010024b:	c7 43 54 58 0d 11 80 	movl   $0x80110d58,0x54(%ebx)
    b->next = bcache.head.next;
80100252:	89 43 58             	mov    %eax,0x58(%ebx)
    bcache.head.next->prev = b;
80100255:	a1 b0 0d 11 80       	mov    0x80110db0,%eax
8010025a:	89 58 54             	mov    %ebx,0x54(%eax)
    bcache.head.next = b;
8010025d:	89 1d b0 0d 11 80    	mov    %ebx,0x80110db0
  }
...
801002b1:	e8 fa 46 00 00       	call   801049b0 <acquire>
...
801002c6:	a1 40 10 11 80       	mov    0x80111040,%eax
801002cb:	3b 05 44 10 11 80    	cmp    0x80111044,%eax
...
801002e0:	68 40 10 11 80       	push   $0x80111040
801002e5:	e8 36 3c 00 00       	call   80103f20 <sleep>
    while(input.r == input.w){
801002ea:	a1 40 10 11 80       	mov    0x80111040,%eax
801002ef:	83 c4 10             	add    $0x10,%esp
801002f2:	3b 05 44 10 11 80    	cmp    0x80111044,%eax
...
80100333:	89 15 40 10 11 80    	mov    %edx,0x80111040
80100339:	89 c2                	mov    %eax,%edx
8010033b:	83 e2 7f             	and    $0x7f,%edx
8010033e:	0f be 8a c0 0f 11 80 	movsbl -0x7feef040(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100384:	73 d7                	jae    8010035d <consoleread+0xcd>
        input.r--;
80100386:	a3 40 10 11 80       	mov    %eax,0x80111040
...
8010039c:	fa                   	cli    
  cons.locking = 0;
8010039d:	c7 05 58 b5 10 80 00 	movl   $0x0,0x8010b558
801003a4:	00 00 00 
  getcallerpcs(&s, pcs);
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 cf 7f 10 80 	movl   $0x80107fcf,(%esp)
...
801003dc:	e8 6f 44 00 00       	call   80104850 <getcallerpcs>
  for(i=0; i<10; i++)
...
80100561:	e8 3a 46 00 00       	call   80104ba0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100576:	e8 85 45 00 00       	call   80104b00 <memset>
...
80100600:	0f be c2             	movsbl %dl,%eax
  if(panicked){
80100603:	8b 15 5c b5 10 80    	mov    0x8010b55c,%edx
...
8010065f:	e8 4c 43 00 00       	call   801049b0 <acquire>
  for(i = 0; i < n; i++)
...
8010066e:	8d 34 1f             	lea    (%edi,%ebx,1),%esi
  if(panicked){
80100671:	8b 15 5c b5 10 80    	mov    0x8010b55c,%edx
...
801006bd:	a1 58 b5 10 80       	mov    0x8010b558,%eax
...
801006ea:	74 44                	je     80100730 <cprintf+0x80>
  if(panicked){
801006ec:	8b 0d 5c b5 10 80    	mov    0x8010b55c,%ecx
...
80100782:	b8 28 00 00 00       	mov    $0x28,%eax
  if(panicked){
80100787:	8b 15 5c b5 10 80    	mov    0x8010b55c,%edx
...
801007bd:	e8 ee 41 00 00       	call   801049b0 <acquire>
...
801007db:	e9 2a ff ff ff       	jmp    8010070a <cprintf+0x5a>
  if(panicked){
801007e0:	8b 3d 5c b5 10 80    	mov    0x8010b55c,%edi
...
801007f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(panicked){
801007f8:	8b 0d 5c b5 10 80    	mov    0x8010b55c,%ecx
...
8010080d:	e8 fe fb ff ff       	call   80100410 <consputc.part.0>
  if(panicked){
80100812:	8b 15 5c b5 10 80    	mov    0x8010b55c,%edx
...
80100877:	e8 34 41 00 00       	call   801049b0 <acquire>
  while((c = getc()) >= 0){
...
801008b4:	a1 48 10 11 80       	mov    0x80111048,%eax
801008b9:	89 c2                	mov    %eax,%edx
801008bb:	2b 15 40 10 11 80    	sub    0x80111040,%edx
801008c1:	83 fa 7f             	cmp    $0x7f,%edx
801008c4:	77 d2                	ja     80100898 <consoleintr+0x38>
        c = (c == '\r') ? '\n' : c;
801008c6:	8d 48 01             	lea    0x1(%eax),%ecx
801008c9:	8b 15 5c b5 10 80    	mov    0x8010b55c,%edx
801008cf:	83 e0 7f             	and    $0x7f,%eax
        input.buf[input.e++ % INPUT_BUF] = c;
801008d2:	89 0d 48 10 11 80    	mov    %ecx,0x80111048
        c = (c == '\r') ? '\n' : c;
801008d8:	83 fb 0d             	cmp    $0xd,%ebx
801008db:	0f 84 02 01 00 00    	je     801009e3 <consoleintr+0x183>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e1:	88 98 c0 0f 11 80    	mov    %bl,-0x7feef040(%eax)
  if(panicked){
...
80100908:	a1 40 10 11 80       	mov    0x80111040,%eax
8010090d:	83 e8 80             	sub    $0xffffff80,%eax
80100910:	39 05 48 10 11 80    	cmp    %eax,0x80111048
80100916:	75 80                	jne    80100898 <consoleintr+0x38>
80100918:	e9 f6 00 00 00       	jmp    80100a13 <consoleintr+0x1b3>
8010091d:	8d 76 00             	lea    0x0(%esi),%esi
      while(input.e != input.w &&
80100920:	a1 48 10 11 80       	mov    0x80111048,%eax
80100925:	39 05 44 10 11 80    	cmp    %eax,0x80111044
...
80100936:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100939:	80 ba c0 0f 11 80 0a 	cmpb   $0xa,-0x7feef040(%edx)
80100940:	0f 84 52 ff ff ff    	je     80100898 <consoleintr+0x38>
  if(panicked){
80100946:	8b 15 5c b5 10 80    	mov    0x8010b55c,%edx
        input.e--;
8010094c:	a3 48 10 11 80       	mov    %eax,0x80111048
  if(panicked){
...
80100965:	e8 a6 fa ff ff       	call   80100410 <consputc.part.0>
      while(input.e != input.w &&
8010096a:	a1 48 10 11 80       	mov    0x80111048,%eax
8010096f:	3b 05 44 10 11 80    	cmp    0x80111044,%eax
80100975:	75 ba                	jne    80100931 <consoleintr+0xd1>
80100977:	e9 1c ff ff ff       	jmp    80100898 <consoleintr+0x38>
8010097c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(input.e != input.w){
80100980:	a1 48 10 11 80       	mov    0x80111048,%eax
80100985:	3b 05 44 10 11 80    	cmp    0x80111044,%eax
8010098b:	0f 84 07 ff ff ff    	je     80100898 <consoleintr+0x38>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 48 10 11 80       	mov    %eax,0x80111048
  if(panicked){
80100999:	a1 5c b5 10 80       	mov    0x8010b55c,%eax
...
801009e2:	c3                   	ret    
        input.buf[input.e++ % INPUT_BUF] = c;
801009e3:	c6 80 c0 0f 11 80 0a 	movb   $0xa,-0x7feef040(%eax)
  if(panicked){
...
80100a09:	e8 02 fa ff ff       	call   80100410 <consputc.part.0>
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
80100a0e:	a1 48 10 11 80       	mov    0x80111048,%eax
          wakeup(&input.r);
80100a13:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a16:	a3 44 10 11 80       	mov    %eax,0x80111044
          wakeup(&input.r);
80100a1b:	68 40 10 11 80       	push   $0x80111040
...
80100a44:	e8 d7 3d 00 00       	call   80104820 <initlock>
...
80100a4d:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a4f:	c7 05 0c 1a 11 80 40 	movl   $0x80100640,0x80111a0c
80100a56:	06 10 80 
  devsw[CONSOLE].read = consoleread;
80100a59:	c7 05 08 1a 11 80 90 	movl   $0x80100290,0x80111a08
80100a60:	02 10 80 
  cons.locking = 1;
80100a63:	c7 05 58 b5 10 80 01 	movl   $0x1,0x8010b558
80100a6a:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100ca3:	e8 58 40 00 00       	call   80104d00 <strlen>
...
80100cb6:	e8 45 40 00 00       	call   80104d00 <strlen>
...
80100d71:	e8 4a 3f 00 00       	call   80104cc0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100def:	68 60 10 11 80       	push   $0x80111060
80100df4:	e8 27 3a 00 00       	call   80104820 <initlock>
}
...
80100e08:	bb 98 10 11 80       	mov    $0x80111098,%ebx
{
80100e0d:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e10:	68 60 10 11 80       	push   $0x80111060
80100e15:	e8 96 3b 00 00       	call   801049b0 <acquire>
80100e1a:	83 c4 10             	add    $0x10,%esp
80100e1d:	eb 0c                	jmp    80100e2b <filealloc+0x2b>
80100e1f:	90                   	nop
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80100e20:	83 c3 18             	add    $0x18,%ebx
80100e23:	81 fb f8 19 11 80    	cmp    $0x801119f8,%ebx
...
80100e53:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e55:	68 60 10 11 80       	push   $0x80111060
...
80100e7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100e7e:	68 60 10 11 80       	push   $0x80111060
80100e83:	e8 28 3b 00 00       	call   801049b0 <acquire>
  if(f->ref < 1)
...
80100e98:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e9b:	68 60 10 11 80       	push   $0x80111060
...
80100ecd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100ed0:	68 60 10 11 80       	push   $0x80111060
80100ed5:	e8 d6 3a 00 00       	call   801049b0 <acquire>
  if(f->ref < 1)
...
80100f05:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f08:	68 60 10 11 80       	push   $0x80111060
  ff = *f;
...
80100f2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f30:	c7 45 08 60 10 11 80 	movl   $0x80111060,0x8(%ebp)
}
...
801011b8:	03 05 78 1a 11 80    	add    0x80111a78,%eax
{
...
801011e4:	d3 e2                	shl    %cl,%edx
  if((bp->data[bi/8] & m) == 0)
801011e6:	0f b6 4c 18 60       	movzbl 0x60(%eax,%ebx,1),%ecx
...
801011f8:	88 54 18 60          	mov    %dl,0x60(%eax,%ebx,1)
  log_write(bp);
...
80101217:	68 1f 77 10 80       	push   $0x8010771f
...
80101239:	8b 0d 60 1a 11 80    	mov    0x80111a60,%ecx
{
...
8010125c:	03 05 78 1a 11 80    	add    0x80111a78,%eax
...
80101271:	a1 60 1a 11 80       	mov    0x80111a60,%eax
...
80101294:	0f b6 7c 0a 60       	movzbl 0x60(%edx,%ecx,1),%edi
...
801012c9:	39 05 60 1a 11 80    	cmp    %eax,0x80111a60
801012cf:	77 80                	ja     80101251 <balloc+0x21>
  panic("balloc: out of blocks");
801012d1:	83 ec 0c             	sub    $0xc,%esp
801012d4:	68 32 77 10 80       	push   $0x80107732
...
801012e8:	88 54 0f 60          	mov    %dl,0x60(%edi,%ecx,1)
        log_write(bp);
...
80101308:	89 c3                	mov    %eax,%ebx
  memset(bp->data, 0, BSIZE);
8010130a:	8d 40 60             	lea    0x60(%eax),%eax
8010130d:	68 00 02 00 00       	push   $0x200
80101312:	6a 00                	push   $0x0
80101314:	50                   	push   %eax
80101315:	e8 e6 37 00 00       	call   80104b00 <memset>
  log_write(bp);
...
8010134a:	bb b8 1a 11 80       	mov    $0x80111ab8,%ebx
{
8010134f:	83 ec 28             	sub    $0x28,%esp
80101352:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101355:	68 80 1a 11 80       	push   $0x80111a80
8010135a:	e8 51 36 00 00       	call   801049b0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101374:	81 c3 94 00 00 00    	add    $0x94,%ebx
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010137a:	81 fb a0 37 11 80    	cmp    $0x801137a0,%ebx
...
8010138f:	81 c3 94 00 00 00    	add    $0x94,%ebx
80101395:	85 c9                	test   %ecx,%ecx
80101397:	75 6e                	jne    80101407 <iget+0xc7>
80101399:	89 c6                	mov    %eax,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010139b:	81 fb a0 37 11 80    	cmp    $0x801137a0,%ebx
...
801013b4:	c7 46 08 01 00 00 00 	movl   $0x1,0x8(%esi)
  ip->valid = 0;
801013bb:	c7 46 50 00 00 00 00 	movl   $0x0,0x50(%esi)
  release(&icache.lock);
801013c2:	68 80 1a 11 80       	push   $0x80111a80
...
801013eb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013ed:	68 80 1a 11 80       	push   $0x80111a80
      ip->ref++;
...
80101406:	c3                   	ret    
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101407:	81 fb a0 37 11 80    	cmp    $0x801137a0,%ebx
...
80101422:	68 48 77 10 80       	push   $0x80107748
...
80101450:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
...
80101469:	8d 54 98 60          	lea    0x60(%eax,%ebx,4),%edx
    bp = bread(ip->dev, addr);
...
801014b9:	89 86 90 00 00 00    	mov    %eax,0x90(%esi)
801014bf:	eb 9b                	jmp    8010145c <bmap+0x2c>
801014c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if((addr = ip->addrs[bn]) == 0)
801014c8:	8d 3c 90             	lea    (%eax,%edx,4),%edi
801014cb:	8b 5f 60             	mov    0x60(%edi),%ebx
801014ce:	85 db                	test   %ebx,%ebx
801014d0:	75 af                	jne    80101481 <bmap+0x51>
      ip->addrs[bn] = addr = balloc(ip->dev);
801014d2:	8b 00                	mov    (%eax),%eax
801014d4:	e8 57 fd ff ff       	call   80101230 <balloc>
801014d9:	89 47 60             	mov    %eax,0x60(%edi)
...
801014eb:	68 58 77 10 80       	push   $0x80107758
...
8010151c:	89 c3                	mov    %eax,%ebx
  memmove(sb, bp->data, sizeof(*sb));
8010151e:	8d 40 60             	lea    0x60(%eax),%eax
80101521:	6a 1c                	push   $0x1c
80101523:	50                   	push   %eax
80101524:	56                   	push   %esi
80101525:	e8 76 36 00 00       	call   80104ba0 <memmove>
  brelse(bp);
...
80101548:	bb c4 1a 11 80       	mov    $0x80111ac4,%ebx
8010154d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
80101550:	68 6b 77 10 80       	push   $0x8010776b
80101555:	68 80 1a 11 80       	push   $0x80111a80
8010155a:	e8 c1 32 00 00       	call   80104820 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101571:	81 c3 94 00 00 00    	add    $0x94,%ebx
80101577:	e8 64 31 00 00       	call   801046e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
8010157c:	83 c4 10             	add    $0x10,%esp
8010157f:	81 fb ac 37 11 80    	cmp    $0x801137ac,%ebx
...
80101597:	ff 35 78 1a 11 80    	pushl  0x80111a78
8010159d:	ff 35 74 1a 11 80    	pushl  0x80111a74
801015a3:	ff 35 70 1a 11 80    	pushl  0x80111a70
801015a9:	ff 35 6c 1a 11 80    	pushl  0x80111a6c
801015af:	ff 35 68 1a 11 80    	pushl  0x80111a68
801015b5:	ff 35 64 1a 11 80    	pushl  0x80111a64
801015bb:	ff 35 60 1a 11 80    	pushl  0x80111a60
801015c1:	68 d8 77 10 80       	push   $0x801077d8
...
801015f0:	83 3d 68 1a 11 80 01 	cmpl   $0x1,0x80111a68
{
...
8010161f:	3b 3d 68 1a 11 80    	cmp    0x80111a68,%edi
80101625:	73 69                	jae    80101690 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101627:	89 f8                	mov    %edi,%eax
80101629:	83 ec 08             	sub    $0x8,%esp
8010162c:	c1 e8 03             	shr    $0x3,%eax
8010162f:	03 05 74 1a 11 80    	add    0x80111a74,%eax
...
80101649:	8d 4c 03 60          	lea    0x60(%ebx,%eax,1),%ecx
    if(dip->type == 0){  // a free inode
...
8010165e:	e8 9d 34 00 00       	call   80104b00 <memset>
      dip->type = type;
...
801016af:	83 c3 60             	add    $0x60,%ebx
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
801016b2:	83 ec 08             	sub    $0x8,%esp
801016b5:	c1 e8 03             	shr    $0x3,%eax
801016b8:	03 05 74 1a 11 80    	add    0x80111a74,%eax
801016be:	50                   	push   %eax
801016bf:	ff 73 a0             	pushl  -0x60(%ebx)
...
801016d0:	8b 43 a4             	mov    -0x5c(%ebx),%eax
801016d3:	83 e0 07             	and    $0x7,%eax
801016d6:	c1 e0 06             	shl    $0x6,%eax
801016d9:	8d 44 06 60          	lea    0x60(%esi,%eax,1),%eax
  dip->type = ip->type;
...
80101705:	e8 96 34 00 00       	call   80104ba0 <memmove>
  log_write(bp);
...
8010173b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010173e:	68 80 1a 11 80       	push   $0x80111a80
80101743:	e8 68 32 00 00       	call   801049b0 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 80 1a 11 80 	movl   $0x80111a80,(%esp)
...
80101786:	e8 95 2f 00 00       	call   80104720 <acquiresleep>
  if(ip->valid == 0){
8010178b:	8b 43 50             	mov    0x50(%ebx),%eax
...
801017a9:	03 05 74 1a 11 80    	add    0x80111a74,%eax
...
801017c5:	8d 44 06 60          	lea    0x60(%esi,%eax,1),%eax
    ip->type = dip->type;
...
801017df:	66 89 53 58          	mov    %dx,0x58(%ebx)
    ip->nlink = dip->nlink;
801017e3:	0f b7 50 fa          	movzwl -0x6(%eax),%edx
801017e7:	66 89 53 5a          	mov    %dx,0x5a(%ebx)
    ip->size = dip->size;
801017eb:	8b 50 fc             	mov    -0x4(%eax),%edx
801017ee:	89 53 5c             	mov    %edx,0x5c(%ebx)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
801017f1:	6a 34                	push   $0x34
801017f3:	50                   	push   %eax
801017f4:	8d 43 60             	lea    0x60(%ebx),%eax
801017f7:	50                   	push   %eax
801017f8:	e8 a3 33 00 00       	call   80104ba0 <memmove>
    brelse(bp);
801017fd:	89 34 24             	mov    %esi,(%esp)
80101800:	e8 eb e9 ff ff       	call   801001f0 <brelse>
    if(ip->type == 0)
80101805:	83 c4 10             	add    $0x10,%esp
80101808:	66 83 7b 54 00       	cmpw   $0x0,0x54(%ebx)
    ip->valid = 1;
8010180d:	c7 43 50 01 00 00 00 	movl   $0x1,0x50(%ebx)
    if(ip->type == 0)
...
80101857:	e8 64 2f 00 00       	call   801047c0 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 08 2f 00 00       	jmp    80104780 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 77 2e 00 00       	call   80104720 <acquiresleep>
  if(ip->valid && ip->nlink == 0){
801018a9:	8b 53 50             	mov    0x50(%ebx),%edx
801018ac:	83 c4 10             	add    $0x10,%esp
801018af:	85 d2                	test   %edx,%edx
801018b1:	74 07                	je     801018ba <iput+0x2a>
801018b3:	66 83 7b 5a 00       	cmpw   $0x0,0x5a(%ebx)
801018b8:	74 36                	je     801018f0 <iput+0x60>
  releasesleep(&ip->lock);
801018ba:	83 ec 0c             	sub    $0xc,%esp
801018bd:	57                   	push   %edi
801018be:	e8 bd 2e 00 00       	call   80104780 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 80 1a 11 80 	movl   $0x80111a80,(%esp)
801018ca:	e8 e1 30 00 00       	call   801049b0 <acquire>
  ip->ref--;
801018cf:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018d3:	83 c4 10             	add    $0x10,%esp
801018d6:	c7 45 08 80 1a 11 80 	movl   $0x80111a80,0x8(%ebp)
}
...
801018f3:	68 80 1a 11 80       	push   $0x80111a80
801018f8:	e8 b3 30 00 00       	call   801049b0 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 80 1a 11 80 	movl   $0x80111a80,(%esp)
80101907:	e8 94 31 00 00       	call   80104aa0 <release>
    if(r == 1){
8010190c:	83 c4 10             	add    $0x10,%esp
8010190f:	83 fe 01             	cmp    $0x1,%esi
80101912:	75 a6                	jne    801018ba <iput+0x2a>
80101914:	8d 8b 90 00 00 00    	lea    0x90(%ebx),%ecx
8010191a:	89 7d e4             	mov    %edi,-0x1c(%ebp)
8010191d:	8d 73 60             	lea    0x60(%ebx),%esi
...
80101944:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(ip->addrs[NDIRECT]){
80101948:	8b 83 90 00 00 00    	mov    0x90(%ebx),%eax
...
80101955:	83 ec 0c             	sub    $0xc,%esp
  ip->size = 0;
80101958:	c7 43 5c 00 00 00 00 	movl   $0x0,0x5c(%ebx)
  iupdate(ip);
8010195f:	53                   	push   %ebx
80101960:	e8 3b fd ff ff       	call   801016a0 <iupdate>
      ip->type = 0;
80101965:	31 c0                	xor    %eax,%eax
80101967:	66 89 43 54          	mov    %ax,0x54(%ebx)
      iupdate(ip);
8010196b:	89 1c 24             	mov    %ebx,(%esp)
8010196e:	e8 2d fd ff ff       	call   801016a0 <iupdate>
      ip->valid = 0;
80101973:	c7 43 50 00 00 00 00 	movl   $0x0,0x50(%ebx)
...
80101999:	8d 88 60 02 00 00    	lea    0x260(%eax),%ecx
8010199f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(j = 0; j < NINDIRECT; j++){
801019a2:	8d 70 60             	lea    0x60(%eax),%esi
...
801019d9:	e8 12 e8 ff ff       	call   801001f0 <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
801019de:	8b 93 90 00 00 00    	mov    0x90(%ebx),%edx
801019e4:	8b 03                	mov    (%ebx),%eax
801019e6:	e8 c5 f7 ff ff       	call   801011b0 <bfree>
    ip->addrs[NDIRECT] = 0;
801019eb:	83 c4 10             	add    $0x10,%esp
801019ee:	c7 83 90 00 00 00 00 	movl   $0x0,0x90(%ebx)
801019f5:	00 00 00 
...
80101a45:	89 48 08             	mov    %ecx,0x8(%eax)
  st->type = ip->type;
80101a48:	0f b7 4a 54          	movzwl 0x54(%edx),%ecx
80101a4c:	66 89 08             	mov    %cx,(%eax)
  st->nlink = ip->nlink;
80101a4f:	0f b7 4a 5a          	movzwl 0x5a(%edx),%ecx
80101a53:	66 89 48 0c          	mov    %cx,0xc(%eax)
  st->size = ip->size;
80101a57:	8b 52 5c             	mov    0x5c(%edx),%edx
...
80101a79:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  if(ip->type == T_DEV){
80101a7c:	66 83 78 54 03       	cmpw   $0x3,0x54(%eax)
{
...
80101a90:	8b 40 5c             	mov    0x5c(%eax),%eax
...
80101af3:	29 c1                	sub    %eax,%ecx
    memmove(dst, bp->data + off%BSIZE, m);
80101af5:	8d 44 02 60          	lea    0x60(%edx,%eax,1),%eax
    m = min(n - tot, BSIZE - off%BSIZE);
...
80101b07:	e8 94 30 00 00       	call   80104ba0 <memmove>
    brelse(bp);
...
80101b2d:	8d 76 00             	lea    0x0(%esi),%esi
    if(ip->major < 0 || ip->major >= NDEV || !devsw[ip->major].read)
80101b30:	0f bf 40 56          	movswl 0x56(%eax),%eax
80101b34:	66 83 f8 09          	cmp    $0x9,%ax
80101b38:	77 17                	ja     80101b51 <readi+0xf1>
80101b3a:	8b 04 c5 00 1a 11 80 	mov    -0x7feee600(,%eax,8),%eax
...
80101b73:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  if(ip->type == T_DEV){
80101b76:	66 83 78 54 03       	cmpw   $0x3,0x54(%eax)
{
...
80101b90:	39 70 5c             	cmp    %esi,0x5c(%eax)
...
80101bf3:	8d 44 07 60          	lea    0x60(%edi,%eax,1),%eax
    m = min(n - tot, BSIZE - off%BSIZE);
...
80101c03:	e8 98 2f 00 00       	call   80104ba0 <memmove>
    log_write(bp);
...
80101c2c:	3b 70 5c             	cmp    0x5c(%eax),%esi
...
80101c3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ip->major < 0 || ip->major >= NDEV || !devsw[ip->major].write)
80101c40:	0f bf 40 56          	movswl 0x56(%eax),%eax
80101c44:	66 83 f8 09          	cmp    $0x9,%ax
80101c48:	77 32                	ja     80101c7c <writei+0x11c>
80101c4a:	8b 04 c5 04 1a 11 80 	mov    -0x7feee5fc(,%eax,8),%eax
...
80101c6b:	83 ec 0c             	sub    $0xc,%esp
    ip->size = off;
80101c6e:	89 70 5c             	mov    %esi,0x5c(%eax)
    iupdate(ip);
...
80101ca2:	e8 69 2f 00 00       	call   80104c10 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101cbd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  if(dp->type != T_DIR)
80101cc0:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
80101cc5:	0f 85 89 00 00 00    	jne    80101d54 <dirlookup+0xa4>
    panic("dirlookup not DIR");

  for(off = 0; off < dp->size; off += sizeof(de)){
80101ccb:	8b 53 5c             	mov    0x5c(%ebx),%edx
...
80101d05:	e8 06 2f 00 00       	call   80104c10 <strncmp>
      continue;
...
80101d14:	3b 7b 5c             	cmp    0x5c(%ebx),%edi
...
80101d94:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101d97:	68 80 1a 11 80       	push   $0x80111a80
80101d9c:	e8 0f 2c 00 00       	call   801049b0 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 80 1a 11 80 	movl   $0x80111a80,(%esp)
...
80101e17:	e8 84 2d 00 00       	call   80104ba0 <memmove>
...
80101e3c:	66 83 7e 54 01       	cmpw   $0x1,0x54(%esi)
...
80101ea3:	e8 f8 2c 00 00       	call   80104ba0 <memmove>
    name[len] = 0;
...
80101f90:	75 6b                	jne    80101ffd <dirlink+0x8d>
  for(off = 0; off < dp->size; off += sizeof(de)){
80101f92:	8b 7b 5c             	mov    0x5c(%ebx),%edi
...
80101fab:	3b 7b 5c             	cmp    0x5c(%ebx),%edi
...
80101fd5:	e8 86 2c 00 00       	call   80104c60 <strncpy>
...
80102020:	68 b6 7d 10 80       	push   $0x80107db6
...
80102110:	b9 80 00 00 00       	mov    $0x80,%ecx
    outsl(0x1f0, b->data, BSIZE/4);
80102115:	8d 73 60             	lea    0x60(%ebx),%esi
...
8010212b:	68 34 78 10 80       	push   $0x80107834
80102130:	e8 5b e2 ff ff       	call   80100390 <panic>
    panic("idestart");
80102135:	83 ec 0c             	sub    $0xc,%esp
80102138:	68 2b 78 10 80       	push   $0x8010782b
...
8010215a:	68 46 78 10 80       	push   $0x80107846
8010215f:	68 80 b5 10 80       	push   $0x8010b580
80102164:	e8 b7 26 00 00       	call   80104820 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102169:	58                   	pop    %eax
8010216a:	a1 a0 3e 11 80       	mov    0x80113ea0,%eax
8010216f:	5a                   	pop    %edx
...
801021f2:	e8 b9 27 00 00       	call   801049b0 <acquire>
...
80102202:	74 5f                	je     80102263 <ideintr+0x83>
  ...
  idequeue = b->qnext;
80102204:	8b 43 5c             	mov    0x5c(%ebx),%eax
...
8010222f:	8d 7b 60             	lea    0x60(%ebx),%edi
...
80102292:	e8 29 25 00 00       	call   801047c0 <holdingsleep>
...
801022cc:	e8 df 26 00 00       	call   801049b0 <acquire>
...
801022d1:	a1 64 b5 10 80       	mov    0x8010b564,%eax
  b->qnext = 0;
801022d6:	c7 43 5c 00 00 00 00 	movl   $0x0,0x5c(%ebx)
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
801022ea:	8b 40 5c             	mov    0x5c(%eax),%eax
801022ed:	85 c0                	test   %eax,%eax
801022ef:	75 f7                	jne    801022e8 <iderw+0x68>
801022f1:	83 c2 5c             	add    $0x5c,%edx
    ;
  *pp = b;
...
8010235a:	68 75 78 10 80       	push   $0x80107875
8010235f:	e8 2c e0 ff ff       	call   80100390 <panic>
    panic("iderw: nothing to do");
80102364:	83 ec 0c             	sub    $0xc,%esp
80102367:	68 60 78 10 80       	push   $0x80107860
8010236c:	e8 1f e0 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102371:	83 ec 0c             	sub    $0xc,%esp
80102374:	68 4a 78 10 80       	push   $0x8010784a
...
80102385:	c7 05 a0 37 11 80 00 	movl   $0xfec00000,0x801137a0
8010238c:	00 c0 fe 
{
...
8010239a:	00 00 00 
  return ioapic->data;
8010239d:	8b 15 a0 37 11 80    	mov    0x801137a0,%edx
801023a3:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023a6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023ac:	8b 0d a0 37 11 80    	mov    0x801137a0,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023b2:	0f b6 15 00 39 11 80 	movzbl 0x80113900,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
801023ce:	68 94 78 10 80       	push   $0x80107894
801023d3:	e8 d8 e2 ff ff       	call   801006b0 <cprintf>
801023d8:	8b 0d a0 37 11 80    	mov    0x801137a0,%ecx
...
801023f2:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
801023f4:	8b 0d a0 37 11 80    	mov    0x801137a0,%ecx
...
8010240c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010240e:	8b 0d a0 37 11 80    	mov    0x801137a0,%ecx
...
80102434:	55                   	push   %ebp
  ioapic->reg = reg;
80102435:	8b 0d a0 37 11 80    	mov    0x801137a0,%ecx
{
...
80102447:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102449:	8b 0d a0 37 11 80    	mov    0x801137a0,%ecx
...
80102458:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010245a:	a1 a0 37 11 80       	mov    0x801137a0,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102486:	81 fb c8 6d 11 80    	cmp    $0x80116dc8,%ebx
...
801024a6:	e8 55 26 00 00       	call   80104b00 <memset>

  if(kmem.use_lock)
801024ab:	8b 15 f8 37 11 80    	mov    0x801137f8,%edx
...
801024b8:	a1 fc 37 11 80       	mov    0x801137fc,%eax
801024bd:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
801024bf:	a1 f8 37 11 80       	mov    0x801137f8,%eax
  kmem.freelist = r;
801024c4:	89 1d fc 37 11 80    	mov    %ebx,0x801137fc
  if(kmem.use_lock)
...
801024db:	68 c0 37 11 80       	push   $0x801137c0
801024e0:	e8 cb 24 00 00       	call   801049b0 <acquire>
801024e5:	83 c4 10             	add    $0x10,%esp
801024e8:	eb ce                	jmp    801024b8 <kfree+0x48>
801024ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801024f0:	c7 45 08 c0 37 11 80 	movl   $0x801137c0,0x8(%ebp)
}
...
80102503:	68 c6 78 10 80       	push   $0x801078c6
...
8010256f:	68 cc 78 10 80       	push   $0x801078cc
80102574:	68 c0 37 11 80       	push   $0x801137c0
80102579:	e8 a2 22 00 00       	call   80104820 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
8010257e:	8b 45 08             	mov    0x8(%ebp),%eax
  for(; p + PGSIZE <= (char*)vend; p += PGSIZE)
80102581:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102584:	c7 05 f8 37 11 80 00 	movl   $0x0,0x801137f8
8010258b:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102612:	73 e4                	jae    801025f8 <kinit2+0x28>
  kmem.use_lock = 1;
80102614:	c7 05 f8 37 11 80 01 	movl   $0x1,0x801137f8
8010261b:	00 00 00 
}
...
80102630:	f3 0f 1e fb          	endbr32 
  ...
  if(kmem.use_lock)
80102634:	a1 f8 37 11 80       	mov    0x801137f8,%eax
80102639:	85 c0                	test   %eax,%eax
8010263b:	75 1b                	jne    80102658 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
8010263d:	a1 fc 37 11 80       	mov    0x801137fc,%eax
  if(r)
80102642:	85 c0                	test   %eax,%eax
80102644:	74 0a                	je     80102650 <kalloc+0x20>
    kmem.freelist = r->next;
80102646:	8b 10                	mov    (%eax),%edx
80102648:	89 15 fc 37 11 80    	mov    %edx,0x801137fc
  if(kmem.use_lock)
8010264e:	c3                   	ret    
8010264f:	90                   	nop
    release(&kmem.lock);
...
8010265b:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
8010265e:	68 c0 37 11 80       	push   $0x801137c0
80102663:	e8 48 23 00 00       	call   801049b0 <acquire>
  r = kmem.freelist;
80102668:	a1 fc 37 11 80       	mov    0x801137fc,%eax
  if(r)
8010266d:	8b 15 f8 37 11 80    	mov    0x801137f8,%edx
80102673:	83 c4 10             	add    $0x10,%esp
80102676:	85 c0                	test   %eax,%eax
80102678:	74 08                	je     80102682 <kalloc+0x52>
    kmem.freelist = r->next;
8010267a:	8b 08                	mov    (%eax),%ecx
8010267c:	89 0d fc 37 11 80    	mov    %ecx,0x801137fc
  if(kmem.use_lock)
...
8010268c:	68 c0 37 11 80       	push   $0x801137c0
...
801026bb:	ec                   	in     (%dx),%al
  return data;
801026bc:	8b 1d b8 b5 10 80    	mov    0x8010b5b8,%ebx
    return -1;
  data = inb(KBDATAP);
...
801026df:	0f b6 8a 00 7a 10 80 	movzbl -0x7fef8600(%edx),%ecx
  shift ^= togglecode[data];
801026e6:	0f b6 82 00 79 10 80 	movzbl -0x7fef8700(%edx),%eax
  shift |= shiftcode[data];
...
801026f1:	89 c8                	mov    %ecx,%eax
  shift ^= togglecode[data];
801026f3:	89 0d b8 b5 10 80    	mov    %ecx,0x8010b5b8
  c = charcode[shift & (CTL | SHIFT)][data];
801026f9:	83 e0 03             	and    $0x3,%eax
  if(shift & CAPSLOCK){
801026fc:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801026ff:	8b 04 85 e0 78 10 80 	mov    -0x7fef8720(,%eax,4),%eax
...
80102723:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102725:	89 1d b8 b5 10 80    	mov    %ebx,0x8010b5b8
}
8010272b:	5b                   	pop    %ebx
8010272c:	5d                   	pop    %ebp
8010272d:	c3                   	ret    
...
80102738:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010273a:	0f b6 8a 00 7a 10 80 	movzbl -0x7fef8600(%edx),%ecx
...
8010274c:	5d                   	pop    %ebp
    shift &= ~(shiftcode[data] | E0ESC);
8010274d:	89 0d b8 b5 10 80    	mov    %ecx,0x8010b5b8
}
80102753:	c3                   	ret    
...
801027a0:	f3 0f 1e fb          	endbr32 
  if(!lapic)
801027a4:	a1 00 38 11 80       	mov    0x80113800,%eax
...
801028a0:	f3 0f 1e fb          	endbr32 
  if (!lapic)
801028a4:	a1 00 38 11 80       	mov    0x80113800,%eax
...
801028c0:	f3 0f 1e fb          	endbr32 
  if(lapic)
801028c4:	a1 00 38 11 80       	mov    0x80113800,%eax
...
8010292c:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
80102932:	a1 00 38 11 80       	mov    0x80113800,%eax
...
80102abf:	e8 8c 20 00 00       	call   80104b50 <memcmp>
...
80102b90:	8b 0d 6c 38 11 80    	mov    0x8011386c,%ecx
...
80102bb0:	a1 58 38 11 80       	mov    0x80113858,%eax
80102bb5:	83 ec 08             	sub    $0x8,%esp
80102bb8:	01 f8                	add    %edi,%eax
80102bba:	83 c0 01             	add    $0x1,%eax
80102bbd:	50                   	push   %eax
80102bbe:	ff 35 68 38 11 80    	pushl  0x80113868
80102bc4:	e8 07 d5 ff ff       	call   801000d0 <bread>
80102bc9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bcb:	58                   	pop    %eax
80102bcc:	5a                   	pop    %edx
80102bcd:	ff 34 bd 70 38 11 80 	pushl  -0x7feec790(,%edi,4)
80102bd4:	ff 35 68 38 11 80    	pushl  0x80113868
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102be5:	89 c3                	mov    %eax,%ebx
    memmove(dbuf->data, lbuf->data, BSIZE);  // copy block to dst
80102be7:	8d 46 60             	lea    0x60(%esi),%eax
80102bea:	68 00 02 00 00       	push   $0x200
80102bef:	50                   	push   %eax
80102bf0:	8d 43 60             	lea    0x60(%ebx),%eax
80102bf3:	50                   	push   %eax
80102bf4:	e8 a7 1f 00 00       	call   80104ba0 <memmove>
...
80102c14:	39 3d 6c 38 11 80    	cmp    %edi,0x8011386c
...
80102c37:	ff 35 58 38 11 80    	pushl  0x80113858
80102c3d:	ff 35 68 38 11 80    	pushl  0x80113868
...
80102c4b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c4d:	a1 6c 38 11 80       	mov    0x8011386c,%eax
80102c52:	89 43 60             	mov    %eax,0x60(%ebx)
  for (i = 0; i < log.lh.n; i++) {
...
80102c60:	8b 0c 95 70 38 11 80 	mov    -0x7feec790(,%edx,4),%ecx
80102c67:	89 4c 93 64          	mov    %ecx,0x64(%ebx,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102c9e:	68 00 7b 10 80       	push   $0x80107b00
80102ca3:	68 20 38 11 80       	push   $0x80113820
80102ca8:	e8 73 1b 00 00       	call   80104820 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102cbc:	59                   	pop    %ecx
  log.dev = dev;
80102cbd:	89 1d 68 38 11 80    	mov    %ebx,0x80113868
  log.size = sb.nlog;
80102cc3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cc6:	a3 58 38 11 80       	mov    %eax,0x80113858
  log.size = sb.nlog;
80102ccb:	89 15 5c 38 11 80    	mov    %edx,0x8011385c
  struct buf *buf = bread(log.dev, log.start);
80102cd1:	5a                   	pop    %edx
...
80102cd9:	83 c4 10             	add    $0x10,%esp
  log.lh.n = lh->n;
80102cdc:	8b 48 60             	mov    0x60(%eax),%ecx
80102cdf:	89 0d 6c 38 11 80    	mov    %ecx,0x8011386c
  for (i = 0; i < log.lh.n; i++) {
...
80102cf0:	8b 5c 90 64          	mov    0x64(%eax,%edx,4),%ebx
80102cf4:	89 1c 95 70 38 11 80 	mov    %ebx,-0x7feec790(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d0b:	e8 80 fe ff ff       	call   80102b90 <install_trans>
  log.lh.n = 0;
80102d10:	c7 05 6c 38 11 80 00 	movl   $0x0,0x8011386c
80102d17:	00 00 00 
...
80102d37:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d3a:	68 20 38 11 80       	push   $0x80113820
80102d3f:	e8 6c 1c 00 00       	call   801049b0 <acquire>
...
80102d53:	68 20 38 11 80       	push   $0x80113820
80102d58:	68 20 38 11 80       	push   $0x80113820
80102d5d:	e8 be 11 00 00       	call   80103f20 <sleep>
80102d62:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d65:	a1 64 38 11 80       	mov    0x80113864,%eax
80102d6a:	85 c0                	test   %eax,%eax
80102d6c:	75 e2                	jne    80102d50 <begin_op+0x20>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d6e:	a1 60 38 11 80       	mov    0x80113860,%eax
80102d73:	8b 15 6c 38 11 80    	mov    0x8011386c,%edx
...
80102d87:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102d8a:	a3 60 38 11 80       	mov    %eax,0x80113860
      release(&log.lock);
80102d8f:	68 20 38 11 80       	push   $0x80113820
...
80102daa:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dad:	68 20 38 11 80       	push   $0x80113820
80102db2:	e8 f9 1b 00 00       	call   801049b0 <acquire>
  log.outstanding -= 1;
80102db7:	a1 60 38 11 80       	mov    0x80113860,%eax
  if(log.committing)
80102dbc:	8b 35 64 38 11 80    	mov    0x80113864,%esi
80102dc2:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102dc5:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102dc8:	89 1d 60 38 11 80    	mov    %ebx,0x80113860
  if(log.committing)
...
80102dd8:	0f 85 f2 00 00 00    	jne    80102ed0 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102dde:	c7 05 64 38 11 80 01 	movl   $0x1,0x80113864
80102de5:	00 00 00 
...
80102deb:	68 20 38 11 80       	push   $0x80113820
...
{
  if (log.lh.n > 0) {
80102df5:	8b 0d 6c 38 11 80    	mov    0x8011386c,%ecx
80102dfb:	83 c4 10             	add    $0x10,%esp
80102dfe:	85 c9                	test   %ecx,%ecx
80102e00:	7f 3e                	jg     80102e40 <end_op+0xa0>
    acquire(&log.lock);
80102e02:	83 ec 0c             	sub    $0xc,%esp
80102e05:	68 20 38 11 80       	push   $0x80113820
80102e0a:	e8 a1 1b 00 00       	call   801049b0 <acquire>
    wakeup(&log);
80102e0f:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
    log.committing = 0;
80102e16:	c7 05 64 38 11 80 00 	movl   $0x0,0x80113864
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 bb 12 00 00       	call   801040e0 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
...
80102e40:	a1 58 38 11 80       	mov    0x80113858,%eax
80102e45:	83 ec 08             	sub    $0x8,%esp
80102e48:	01 d8                	add    %ebx,%eax
80102e4a:	83 c0 01             	add    $0x1,%eax
80102e4d:	50                   	push   %eax
80102e4e:	ff 35 68 38 11 80    	pushl  0x80113868
80102e54:	e8 77 d2 ff ff       	call   801000d0 <bread>
80102e59:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e5b:	58                   	pop    %eax
80102e5c:	5a                   	pop    %edx
80102e5d:	ff 34 9d 70 38 11 80 	pushl  -0x7feec790(,%ebx,4)
80102e64:	ff 35 68 38 11 80    	pushl  0x80113868
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102e75:	89 c7                	mov    %eax,%edi
    memmove(to->data, from->data, BSIZE);
80102e77:	8d 40 60             	lea    0x60(%eax),%eax
80102e7a:	68 00 02 00 00       	push   $0x200
80102e7f:	50                   	push   %eax
80102e80:	8d 46 60             	lea    0x60(%esi),%eax
80102e83:	50                   	push   %eax
80102e84:	e8 17 1d 00 00       	call   80104ba0 <memmove>
...
80102ea4:	3b 1d 6c 38 11 80    	cmp    0x8011386c,%ebx
...
80102eb1:	e8 da fc ff ff       	call   80102b90 <install_trans>
    log.lh.n = 0;
80102eb6:	c7 05 6c 38 11 80 00 	movl   $0x0,0x8011386c
80102ebd:	00 00 00 
...
80102ed3:	68 20 38 11 80       	push   $0x80113820
80102ed8:	e8 03 12 00 00       	call   801040e0 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
...
80102ef7:	68 04 7b 10 80       	push   $0x80107b04
...
80102f1b:	8b 15 6c 38 11 80    	mov    0x8011386c,%edx
{
80102f21:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f24:	83 fa 1d             	cmp    $0x1d,%edx
80102f27:	0f 8f 91 00 00 00    	jg     80102fbe <log_write+0xae>
80102f2d:	a1 5c 38 11 80       	mov    0x8011385c,%eax
80102f32:	83 e8 01             	sub    $0x1,%eax
80102f35:	39 c2                	cmp    %eax,%edx
80102f37:	0f 8d 81 00 00 00    	jge    80102fbe <log_write+0xae>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f3d:	a1 60 38 11 80       	mov    0x80113860,%eax
...
80102f4d:	68 20 38 11 80       	push   $0x80113820
80102f52:	e8 59 1a 00 00       	call   801049b0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f57:	8b 15 6c 38 11 80    	mov    0x8011386c,%edx
...
80102f75:	74 29                	je     80102fa0 <log_write+0x90>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f77:	39 0c 85 70 38 11 80 	cmp    %ecx,-0x7feec790(,%eax,4)
80102f7e:	75 f0                	jne    80102f70 <log_write+0x60>
      break;
  }
  log.lh.block[i] = b->blockno;
80102f80:	89 0c 85 70 38 11 80 	mov    %ecx,-0x7feec790(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102f8a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102f8d:	c7 45 08 20 38 11 80 	movl   $0x80113820,0x8(%ebp)
}
80102f94:	c9                   	leave  
  release(&log.lock);
...
80102f9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 95 70 38 11 80 	mov    %ecx,-0x7feec790(,%edx,4)
    log.lh.n++;
80102fa7:	83 c2 01             	add    $0x1,%edx
80102faa:	89 15 6c 38 11 80    	mov    %edx,0x8011386c
80102fb0:	eb d5                	jmp    80102f87 <log_write+0x77>
  log.lh.block[i] = b->blockno;
80102fb2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fb5:	a3 70 38 11 80       	mov    %eax,0x80113870
  if (i == log.lh.n)
80102fba:	75 cb                	jne    80102f87 <log_write+0x77>
80102fbc:	eb e9                	jmp    80102fa7 <log_write+0x97>
    panic("too big a transaction");
80102fbe:	83 ec 0c             	sub    $0xc,%esp
80102fc1:	68 13 7b 10 80       	push   $0x80107b13
80102fc6:	e8 c5 d3 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102fcb:	83 ec 0c             	sub    $0xc,%esp
80102fce:	68 29 7b 10 80       	push   $0x80107b29
...
80102ff8:	68 44 7b 10 80       	push   $0x80107b44
80102ffd:	e8 ae d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103002:	e8 89 2e 00 00       	call   80105e90 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 31 3f 00 00       	call   80106f60 <switchkvm>
  seginit();
8010302f:	e8 9c 3e 00 00       	call   80106ed0 <seginit>
  lapicinit();
...
8010305b:	68 c8 6d 11 80       	push   $0x80116dc8
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 d6 43 00 00       	call   80107440 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 57 3e 00 00       	call   80106ed0 <seginit>
  picinit();       // disable pic
...
80103088:	e8 03 31 00 00       	call   80106190 <uartinit>
  pinit();         // process table
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 79 2d 00 00       	call   80105e10 <tvinit>
  binit();         // buffer cache
...
801030b8:	e8 e3 1a 00 00       	call   80104ba0 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030bd:	83 c4 10             	add    $0x10,%esp
801030c0:	69 05 a0 3e 11 80 b0 	imul   $0xb0,0x80113ea0,%eax
801030c7:	00 00 00 
801030ca:	05 20 39 11 80       	add    $0x80113920,%eax
801030cf:	3d 20 39 11 80       	cmp    $0x80113920,%eax
801030d4:	76 7a                	jbe    80103150 <main+0x110>
801030d6:	bb 20 39 11 80       	mov    $0x80113920,%ebx
801030db:	eb 1c                	jmp    801030f9 <main+0xb9>
801030dd:	8d 76 00             	lea    0x0(%esi),%esi
801030e0:	69 05 a0 3e 11 80 b0 	imul   $0xb0,0x80113ea0,%eax
801030e7:	00 00 00 
801030ea:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801030f0:	05 20 39 11 80       	add    $0x80113920,%eax
...
8010319e:	68 58 7b 10 80       	push   $0x80107b58
801031a3:	56                   	push   %esi
801031a4:	e8 a7 19 00 00       	call   80104b50 <memcmp>
...
8010325a:	68 5d 7b 10 80       	push   $0x80107b5d
8010325f:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 e8 18 00 00       	call   80104b50 <memcmp>
...
801032be:	a3 00 38 11 80       	mov    %eax,0x80113800
...
8010334c:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
8010334f:	88 0d 00 39 11 80    	mov    %cl,0x80113900
      continue;
80103355:	eb 89                	jmp    801032e0 <mpinit+0xf0>
80103357:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010335e:	66 90                	xchg   %ax,%ax
      if(ncpu < NCPU) {
80103360:	8b 0d a0 3e 11 80    	mov    0x80113ea0,%ecx
...
80103378:	89 0d a0 3e 11 80    	mov    %ecx,0x80113ea0
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f 20 39 11 80    	mov    %bl,-0x7feec6e0(%edi)
...
801033b3:	68 62 7b 10 80       	push   $0x80107b62
801033b8:	e8 d3 cf ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801033bd:	83 ec 0c             	sub    $0xc,%esp
801033c0:	68 7c 7b 10 80       	push   $0x80107b7c
...
80103436:	0f 84 b4 00 00 00    	je     801034f0 <pipealloc+0x100>
    goto bad;
  p->readopen = 1;
8010343c:	c7 80 40 02 00 00 01 	movl   $0x1,0x240(%eax)
80103443:	00 00 00 
  p->writeopen = 1;
  p->nwrite = 0;
  p->nread = 0;
...
80103446:	83 ec 08             	sub    $0x8,%esp
  p->writeopen = 1;
80103449:	c7 80 44 02 00 00 01 	movl   $0x1,0x244(%eax)
80103450:	00 00 00 
  p->nwrite = 0;
80103453:	c7 80 3c 02 00 00 00 	movl   $0x0,0x23c(%eax)
8010345a:	00 00 00 
  p->nread = 0;
8010345d:	c7 80 38 02 00 00 00 	movl   $0x0,0x238(%eax)
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 9b 7b 10 80       	push   $0x80107b9b
8010346c:	50                   	push   %eax
8010346d:	e8 ae 13 00 00       	call   80104820 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 98 14 00 00       	call   801049b0 <acquire>
  if(writable){
...
80103522:	8d 83 38 02 00 00    	lea    0x238(%ebx),%eax
    p->writeopen = 0;
80103528:	c7 83 44 02 00 00 00 	movl   $0x0,0x244(%ebx)
8010352f:	00 00 00 
    wakeup(&p->nread);
...
80103545:	8b 83 44 02 00 00    	mov    0x244(%ebx),%eax
...
80103563:	8d 83 3c 02 00 00    	lea    0x23c(%ebx),%eax
    p->readopen = 0;
80103569:	c7 83 40 02 00 00 00 	movl   $0x0,0x240(%ebx)
80103570:	00 00 00 
    wakeup(&p->nwrite);
...
801035b1:	e8 fa 13 00 00       	call   801049b0 <acquire>
  for(i = 0; i < n; i++){
...
801035c7:	8b 8b 3c 02 00 00    	mov    0x23c(%ebx),%ecx
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
      ...
      wakeup(&p->nread);
801035cd:	8d bb 38 02 00 00    	lea    0x238(%ebx),%edi
801035d3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801035d6:	03 45 10             	add    0x10(%ebp),%eax
801035d9:	89 45 e0             	mov    %eax,-0x20(%ebp)
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
801035dc:	8b 83 38 02 00 00    	mov    0x238(%ebx),%eax
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801035e2:	8d b3 3c 02 00 00    	lea    0x23c(%ebx),%esi
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103611:	e8 0a 09 00 00       	call   80103f20 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
80103616:	8b 83 38 02 00 00    	mov    0x238(%ebx),%eax
8010361c:	8b 93 3c 02 00 00    	mov    0x23c(%ebx),%edx
80103622:	83 c4 10             	add    $0x10,%esp
80103625:	05 00 02 00 00       	add    $0x200,%eax
8010362a:	39 c2                	cmp    %eax,%edx
8010362c:	75 2a                	jne    80103658 <pipewrite+0xb8>
      if(p->readopen == 0 || myproc()->killed){
8010362e:	8b 83 40 02 00 00    	mov    0x240(%ebx),%eax
...
80103664:	89 8b 3c 02 00 00    	mov    %ecx,0x23c(%ebx)
8010366a:	0f b6 06             	movzbl (%esi),%eax
8010366d:	83 c6 01             	add    $0x1,%esi
80103670:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80103673:	88 44 13 38          	mov    %al,0x38(%ebx,%edx,1)
  for(i = 0; i < n; i++){
80103677:	3b 75 e0             	cmp    -0x20(%ebp),%esi
8010367a:	0f 85 5c ff ff ff    	jne    801035dc <pipewrite+0x3c>
  wakeup(&p->nread);  //DOC: pipewrite-wakeup1
80103680:	83 ec 0c             	sub    $0xc,%esp
80103683:	8d 83 38 02 00 00    	lea    0x238(%ebx),%eax
...
801036b4:	8d 9e 38 02 00 00    	lea    0x238(%esi),%ebx
801036ba:	e8 f1 12 00 00       	call   801049b0 <acquire>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
801036bf:	8b 86 38 02 00 00    	mov    0x238(%esi),%eax
801036c5:	83 c4 10             	add    $0x10,%esp
801036c8:	39 86 3c 02 00 00    	cmp    %eax,0x23c(%esi)
...
801036ed:	e8 2e 08 00 00       	call   80103f20 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
801036f2:	8b 86 3c 02 00 00    	mov    0x23c(%esi),%eax
801036f8:	83 c4 10             	add    $0x10,%esp
801036fb:	39 86 38 02 00 00    	cmp    %eax,0x238(%esi)
80103701:	75 0a                	jne    8010370d <piperead+0x6d>
80103703:	8b 86 44 02 00 00    	mov    0x244(%esi),%eax
...
80103728:	89 8e 38 02 00 00    	mov    %ecx,0x238(%esi)
8010372e:	0f b6 44 06 38       	movzbl 0x38(%esi,%eax,1),%eax
...
8010373c:	74 0e                	je     8010374c <piperead+0xac>
    if(p->nread == p->nwrite)
8010373e:	8b 86 38 02 00 00    	mov    0x238(%esi),%eax
80103744:	3b 86 3c 02 00 00    	cmp    0x23c(%esi),%eax
8010374a:	75 d4                	jne    80103720 <piperead+0x80>
  }
  wakeup(&p->nwrite);  //DOC: piperead-wakeup
8010374c:	83 ec 0c             	sub    $0xc,%esp
8010374f:	8d 86 3c 02 00 00    	lea    0x23c(%esi),%eax
...
80103794:	bb 78 46 11 80       	mov    $0x80114678,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 40 46 11 80       	push   $0x80114640
801037a1:	e8 0a 12 00 00       	call   801049b0 <acquire>
...
801037b3:	81 fb 78 65 11 80    	cmp    $0x80116578,%ebx
...
801037d4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037d7:	68 40 46 11 80       	push   $0x80114640
  p->pid = nextpid++;
801037dc:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
801037e2:	e8 b9 12 00 00       	call   80104aa0 <release>
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 f8 5d 10 80 	movl   $0x80105df8,0x14(%eax)
  p->context = (struct context*)sp;
...
80103816:	e8 e5 12 00 00       	call   80104b00 <memset>
...
80103833:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103835:	68 40 46 11 80       	push   $0x80114640
8010383a:	e8 61 12 00 00       	call   80104aa0 <release>
}
...
80103867:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010386a:	68 40 46 11 80       	push   $0x80114640
8010386f:	e8 2c 12 00 00       	call   80104aa0 <release>
...
801038ba:	68 a0 7b 10 80       	push   $0x80107ba0
801038bf:	68 40 46 11 80       	push   $0x80114640
801038c4:	e8 57 0f 00 00       	call   80104820 <initlock>
}
...
801038e0:	e8 bb ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801038e5:	8b 35 a0 3e 11 80    	mov    0x80113ea0,%esi
  apicid = lapicid();
...
80103905:	0f b6 81 20 39 11 80 	movzbl -0x7feec6e0(%ecx),%eax
8010390c:	39 d8                	cmp    %ebx,%eax
8010390e:	75 e8                	jne    801038f8 <mycpu+0x28>
}
80103910:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103913:	8d 81 20 39 11 80    	lea    -0x7feec6e0(%ecx),%eax
}
80103919:	5b                   	pop    %ebx
8010391a:	5e                   	pop    %esi
8010391b:	5d                   	pop    %ebp
...
8010394f:	c9                   	leave  
  return mycpu()-cpus;
80103950:	2d 20 39 11 80       	sub    $0x80113920,%eax
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 40 0f 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 80 0f 00 00       	call   80104900 <popcli>
}
...
801039a0:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039a2:	a3 bc b5 10 80       	mov    %eax,0x8010b5bc
  if((p->pgdir = setupkvm()) == 0)
801039a7:	e8 14 3a 00 00       	call   801073c0 <setupkvm>
...
801039c5:	e8 c6 36 00 00       	call   80107090 <inituvm>
...
801039da:	e8 21 11 00 00       	call   80104b00 <memset>
...
80103a33:	68 d0 7b 10 80       	push   $0x80107bd0
80103a38:	50                   	push   %eax
80103a39:	e8 82 12 00 00       	call   80104cc0 <safestrcpy>
  p->cwd = namei("/");
80103a3e:	c7 04 24 d9 7b 10 80 	movl   $0x80107bd9,(%esp)
80103a45:	e8 e6 e5 ff ff       	call   80102030 <namei>
80103a4a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a4d:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
80103a54:	e8 57 0f 00 00       	call   801049b0 <acquire>
  p->state = RUNNABLE;
80103a59:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a60:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
80103a67:	e8 34 10 00 00       	call   80104aa0 <release>
}
...
80103a77:	68 b7 7b 10 80       	push   $0x80107bb7
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 0f 0e 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 4f 0e 00 00       	call   80104900 <popcli>
  sz = curproc->sz;
...
80103abf:	e8 bc 34 00 00       	call   80106f80 <switchuvm>
  return 0;
...
80103ada:	e8 01 37 00 00       	call   801071e0 <allocuvm>
...
80103afa:	e8 11 38 00 00       	call   80107310 <deallocuvm>
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 8e 0d 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 ce 0d 00 00       	call   80104900 <popcli>
  if((np = allocproc()) == 0){
...
80103b4c:	e8 3f 39 00 00       	call   80107490 <copyuvm>
...
80103bc9:	e8 f2 10 00 00       	call   80104cc0 <safestrcpy>
  pid = np->pid;
80103bce:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bd1:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
80103bd8:	e8 d3 0d 00 00       	call   801049b0 <acquire>
  np->state = RUNNABLE;
80103bdd:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103be4:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
80103beb:	e8 b0 0e 00 00       	call   80104aa0 <release>
  return pid;
...
80103c59:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c5c:	bb 78 46 11 80       	mov    $0x80114678,%ebx
    acquire(&ptable.lock);
80103c61:	68 40 46 11 80       	push   $0x80114640
80103c66:	e8 45 0d 00 00       	call   801049b0 <acquire>
...
80103c80:	e8 fb 32 00 00       	call   80106f80 <switchuvm>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 8c 10 00 00       	call   80104d23 <swtch>
      switchkvm();
80103c97:	e8 c4 32 00 00       	call   80106f60 <switchkvm>
      c->proc = 0;
...
80103cac:	81 fb 78 65 11 80    	cmp    $0x80116578,%ebx
80103cb2:	75 bc                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
80103cb7:	68 40 46 11 80       	push   $0x80114640
80103cbc:	e8 df 0d 00 00       	call   80104aa0 <release>
    sti();
...
80103cf1:	68 40 46 11 80       	push   $0x80114640
80103cf6:	e8 65 0c 00 00       	call   80104960 <holding>
...
80103d37:	e8 e7 0f 00 00       	call   80104d23 <swtch>
  mycpu()->intena = intena;
...
80103dfc:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103e03:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
80103e0a:	e8 a1 0b 00 00       	call   801049b0 <acquire>
...
80103e3f:	3d 78 65 11 80       	cmp    $0x80116578,%eax
80103e44:	75 e4                	jne    80103e2a <exit+0x9a>
      p->parent = initproc;
80103e46:	8b 0d bc b5 10 80    	mov    0x8010b5bc,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e4c:	ba 78 46 11 80       	mov    $0x80114678,%edx
80103e51:	eb 10                	jmp    80103e63 <exit+0xd3>
80103e53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e57:	90                   	nop
80103e58:	83 c2 7c             	add    $0x7c,%edx
80103e5b:	81 fa 78 65 11 80    	cmp    $0x80116578,%edx
...
80103edb:	68 40 46 11 80       	push   $0x80114640
80103ee0:	e8 cb 0a 00 00       	call   801049b0 <acquire>
  pushcli();
80103ee5:	e8 c6 09 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 06 0a 00 00       	call   80104900 <popcli>
  myproc()->state = RUNNABLE;
80103efa:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103f01:	e8 ca fd ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80103f06:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
80103f0d:	e8 8e 0b 00 00       	call   80104aa0 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 78 09 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 b8 09 00 00       	call   80104900 <popcli>
  if(p == 0)
...
80103f54:	81 fe 40 46 11 80    	cmp    $0x80114640,%esi
80103f5a:	74 4c                	je     80103fa8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103f5c:	83 ec 0c             	sub    $0xc,%esp
80103f5f:	68 40 46 11 80       	push   $0x80114640
80103f64:	e8 47 0a 00 00       	call   801049b0 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 2f 0b 00 00       	call   80104aa0 <release>
  p->chan = chan;
...
80103f80:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103f87:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
80103f8e:	e8 0d 0b 00 00       	call   80104aa0 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 0b 0a 00 00       	jmp    801049b0 <acquire>
...
80103fc9:	68 3a 7c 10 80       	push   $0x80107c3a
80103fce:	e8 bd c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fd3:	83 ec 0c             	sub    $0xc,%esp
80103fd6:	68 34 7c 10 80       	push   $0x80107c34
...
80103fe8:	53                   	push   %ebx
  pushcli();
80103fe9:	e8 c2 08 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80103fee:	e8 dd f8 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103ff3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ff9:	e8 02 09 00 00       	call   80104900 <popcli>
  acquire(&ptable.lock);
80103ffe:	83 ec 0c             	sub    $0xc,%esp
80104001:	68 40 46 11 80       	push   $0x80114640
80104006:	e8 a5 09 00 00       	call   801049b0 <acquire>
8010400b:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010400e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104010:	bb 78 46 11 80       	mov    $0x80114678,%ebx
...
80104023:	81 fb 78 65 11 80    	cmp    $0x80116578,%ebx
...
80104039:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403e:	81 fb 78 65 11 80    	cmp    $0x80116578,%ebx
...
80104054:	68 40 46 11 80       	push   $0x80114640
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 ba 32 00 00       	call   80107340 <freevm>
        release(&ptable.lock);
80104086:	c7 04 24 40 46 11 80 	movl   $0x80114640,(%esp)
        p->pid = 0;
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 ee 09 00 00       	call   80104aa0 <release>
        return pid;
...
801040c1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040c6:	68 40 46 11 80       	push   $0x80114640
801040cb:	e8 d0 09 00 00       	call   80104aa0 <release>
      return -1;
...
801040eb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801040ee:	68 40 46 11 80       	push   $0x80114640
801040f3:	e8 b8 08 00 00       	call   801049b0 <acquire>
801040f8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040fb:	b8 78 46 11 80       	mov    $0x80114678,%eax
80104100:	eb 10                	jmp    80104112 <wakeup+0x32>
80104102:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104108:	83 c0 7c             	add    $0x7c,%eax
8010410b:	3d 78 65 11 80       	cmp    $0x80116578,%eax
...
80104127:	3d 78 65 11 80       	cmp    $0x80116578,%eax
8010412c:	75 e4                	jne    80104112 <wakeup+0x32>
  wakeup1(chan);
  release(&ptable.lock);
8010412e:	c7 45 08 40 46 11 80 	movl   $0x80114640,0x8(%ebp)
}
80104135:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 62 09 00 00       	jmp    80104aa0 <release>
...
8010414b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010414e:	68 40 46 11 80       	push   $0x80114640
80104153:	e8 58 08 00 00       	call   801049b0 <acquire>
80104158:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010415b:	b8 78 46 11 80       	mov    $0x80114678,%eax
80104160:	eb 10                	jmp    80104172 <kill+0x32>
80104162:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104168:	83 c0 7c             	add    $0x7c,%eax
8010416b:	3d 78 65 11 80       	cmp    $0x80116578,%eax
...
8010418e:	68 40 46 11 80       	push   $0x80114640
80104193:	e8 08 09 00 00       	call   80104aa0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041ab:	68 40 46 11 80       	push   $0x80114640
801041b0:	e8 eb 08 00 00       	call   80104aa0 <release>
}
...
801041dd:	bb e4 46 11 80       	mov    $0x801146e4,%ebx
...
80104214:	74 ea                	je     80104200 <procdump+0x30>
      state = "???";
80104216:	ba 4b 7c 10 80       	mov    $0x80107c4b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010421b:	83 f8 05             	cmp    $0x5,%eax
8010421e:	77 11                	ja     80104231 <procdump+0x61>
80104220:	8b 14 85 b0 7c 10 80 	mov    -0x7fef8350(,%eax,4),%edx
      state = "???";
80104227:	b8 4b 7c 10 80       	mov    $0x80107c4b,%eax
...
80104236:	68 4f 7c 10 80       	push   $0x80107c4f
...
8010425d:	e8 ee 05 00 00       	call   80104850 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104275:	68 a1 76 10 80       	push   $0x801076a1
...
801042a0 <add_to_sem_queue>:
  struct proc* queue[NPROC];
} semaphores[SEMAPHORE_COUNT];


void add_to_sem_queue(int i, struct proc* proc)
{
...
801042a9:	8b 4d 08             	mov    0x8(%ebp),%ecx
801042ac:	8d 14 89             	lea    (%ecx,%ecx,4),%edx
801042af:	c1 e2 06             	shl    $0x6,%edx
801042b2:	eb 0c                	jmp    801042c0 <add_to_sem_queue+0x20>
801042b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (int j = 0; j < NPROC; j++) {
801042b8:	83 c0 01             	add    $0x1,%eax
801042bb:	83 f8 40             	cmp    $0x40,%eax
801042be:	74 1e                	je     801042de <add_to_sem_queue+0x3e>
    if (semaphores[i].queue[j] == 0) {
801042c0:	83 bc 82 00 3f 11 80 	cmpl   $0x0,-0x7feec100(%edx,%eax,4)
801042c7:	00 
801042c8:	75 ee                	jne    801042b8 <add_to_sem_queue+0x18>
      semaphores[i].queue[j] = proc;
801042ca:	8d 14 89             	lea    (%ecx,%ecx,4),%edx
801042cd:	c1 e2 04             	shl    $0x4,%edx
801042d0:	8d 44 10 10          	lea    0x10(%eax,%edx,1),%eax
801042d4:	8b 55 0c             	mov    0xc(%ebp),%edx
801042d7:	89 14 85 c0 3e 11 80 	mov    %edx,-0x7feec140(,%eax,4)
      return;
    }
  }
}
...
801042ed:	8d 0c 9b             	lea    (%ebx,%ebx,4),%ecx
801042f0:	c1 e1 06             	shl    $0x6,%ecx
801042f3:	8b b1 00 3f 11 80    	mov    -0x7feec100(%ecx),%esi
801042f9:	85 f6                	test   %esi,%esi
801042fb:	74 3c                	je     80104339 <pop_sem_queue+0x59>
    return 0;
...
801042ff:	eb 13                	jmp    80104314 <pop_sem_queue+0x34>
...
80104308:	89 94 81 fc 3e 11 80 	mov    %edx,-0x7feec104(%ecx,%eax,4)
  for (j = 0; j < NPROC - 1; j++) {
8010430f:	83 f8 3f             	cmp    $0x3f,%eax
80104312:	74 25                	je     80104339 <pop_sem_queue+0x59>
    if (semaphores[i].queue[j+1] != 0)
80104314:	89 c7                	mov    %eax,%edi
80104316:	83 c0 01             	add    $0x1,%eax
80104319:	8b 94 81 00 3f 11 80 	mov    -0x7feec100(%ecx,%eax,4),%edx
80104320:	85 d2                	test   %edx,%edx
80104322:	75 e4                	jne    80104308 <pop_sem_queue+0x28>
    else {
      semaphores[i].queue[j] = 0;
80104324:	8d 04 9b             	lea    (%ebx,%ebx,4),%eax
80104327:	c1 e0 04             	shl    $0x4,%eax
8010432a:	8d 44 07 10          	lea    0x10(%edi,%eax,1),%eax
8010432e:	c7 04 85 c0 3e 11 80 	movl   $0x0,-0x7feec140(,%eax,4)
80104335:	00 00 00 00 
      break;
    }
  }
...
8010434d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104350:	8d 04 92             	lea    (%edx,%edx,4),%eax
  semaphores[i].curr_procs = 0;
  initlock(&(semaphores[i].lock), (char*)i + '0');
80104353:	83 c2 30             	add    $0x30,%edx
  semaphores[i].max_procs = v;
80104356:	c1 e0 06             	shl    $0x6,%eax
  initlock(&(semaphores[i].lock), (char*)i + '0');
80104359:	52                   	push   %edx
  semaphores[i].max_procs = v;
8010435a:	89 88 c0 3e 11 80    	mov    %ecx,-0x7feec140(%eax)
  semaphores[i].curr_procs = 0;
80104360:	c7 80 c4 3e 11 80 00 	movl   $0x0,-0x7feec13c(%eax)
80104367:	00 00 00 
  initlock(&(semaphores[i].lock), (char*)i + '0');
8010436a:	05 c8 3e 11 80       	add    $0x80113ec8,%eax
8010436f:	50                   	push   %eax
80104370:	e8 ab 04 00 00       	call   80104820 <initlock>

  return 1;
}
80104375:	b8 01 00 00 00       	mov    $0x1,%eax
8010437a:	c9                   	leave  
8010437b:	c3                   	ret    
8010437c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80104380 <sem_acquire>:
...
8010438a:	83 ec 1c             	sub    $0x1c,%esp
8010438d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104390:	e8 1b 05 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80104395:	e8 36 f5 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
8010439a:	8d 3c 9b             	lea    (%ebx,%ebx,4),%edi
8010439d:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801043a3:	c1 e7 06             	shl    $0x6,%edi
  struct proc* p = myproc();
  acquire(&(semaphores[i].lock));
801043a6:	8d b7 c8 3e 11 80    	lea    -0x7feec138(%edi),%esi
  p = c->proc;
801043ac:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  popcli();
801043af:	e8 4c 05 00 00       	call   80104900 <popcli>
  acquire(&(semaphores[i].lock));
801043b4:	83 ec 0c             	sub    $0xc,%esp
801043b7:	56                   	push   %esi
801043b8:	e8 f3 05 00 00       	call   801049b0 <acquire>
  if (semaphores[i].curr_procs < semaphores[i].max_procs) {
801043bd:	8b 87 c4 3e 11 80    	mov    -0x7feec13c(%edi),%eax
801043c3:	83 c4 10             	add    $0x10,%esp
801043c6:	3b 87 c0 3e 11 80    	cmp    -0x7feec140(%edi),%eax
801043cc:	7d 22                	jge    801043f0 <sem_acquire+0x70>
    semaphores[i].curr_procs += 1;
801043ce:	83 c0 01             	add    $0x1,%eax
801043d1:	89 87 c4 3e 11 80    	mov    %eax,-0x7feec13c(%edi)
  else {
...
801043db:	e8 c0 06 00 00       	call   80104aa0 <release>

  return 1;
}
801043e0:	8d 65 f4             	lea    -0xc(%ebp),%esp
801043e3:	b8 01 00 00 00       	mov    $0x1,%eax
801043e8:	5b                   	pop    %ebx
801043e9:	5e                   	pop    %esi
801043ea:	5f                   	pop    %edi
801043eb:	5d                   	pop    %ebp
...
801043f2:	eb 0c                	jmp    80104400 <sem_acquire+0x80>
801043f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801043f8:	83 c0 01             	add    $0x1,%eax
801043fb:	83 f8 40             	cmp    $0x40,%eax
801043fe:	74 1f                	je     8010441f <sem_acquire+0x9f>
    if (semaphores[i].queue[j] == 0) {
80104400:	8b 94 87 00 3f 11 80 	mov    -0x7feec100(%edi,%eax,4),%edx
80104407:	85 d2                	test   %edx,%edx
80104409:	75 ed                	jne    801043f8 <sem_acquire+0x78>
      semaphores[i].queue[j] = proc;
8010440b:	8d 0c 9b             	lea    (%ebx,%ebx,4),%ecx
8010440e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104411:	c1 e1 04             	shl    $0x4,%ecx
80104414:	8d 44 08 10          	lea    0x10(%eax,%ecx,1),%eax
80104418:	89 14 85 c0 3e 11 80 	mov    %edx,-0x7feec140(,%eax,4)
    sleep(p, &(semaphores[i].lock));
8010441f:	83 ec 08             	sub    $0x8,%esp
80104422:	56                   	push   %esi
80104423:	ff 75 e4             	pushl  -0x1c(%ebp)
80104426:	e8 f5 fa ff ff       	call   80103f20 <sleep>
    semaphores[i].curr_procs += 1;
8010442b:	8d 04 9b             	lea    (%ebx,%ebx,4),%eax
8010442e:	83 c4 10             	add    $0x10,%esp
80104431:	c1 e0 06             	shl    $0x6,%eax
80104434:	83 80 c4 3e 11 80 01 	addl   $0x1,-0x7feec13c(%eax)
8010443b:	eb 9a                	jmp    801043d7 <sem_acquire+0x57>
8010443d:	8d 76 00             	lea    0x0(%esi),%esi

80104440 <sem_release>:
...
8010444a:	83 ec 28             	sub    $0x28,%esp
8010444d:	8b 75 08             	mov    0x8(%ebp),%esi
80104450:	8d 1c b6             	lea    (%esi,%esi,4),%ebx
80104453:	c1 e3 06             	shl    $0x6,%ebx
  struct proc* p = 0;
  acquire(&(semaphores[i].lock));
80104456:	8d bb c8 3e 11 80    	lea    -0x7feec138(%ebx),%edi
8010445c:	57                   	push   %edi
8010445d:	e8 4e 05 00 00       	call   801049b0 <acquire>
  if(semaphores[i].curr_procs > 0)
80104462:	8b 83 c4 3e 11 80    	mov    -0x7feec13c(%ebx),%eax
80104468:	83 c4 10             	add    $0x10,%esp
8010446b:	85 c0                	test   %eax,%eax
8010446d:	7e 09                	jle    80104478 <sem_release+0x38>
    semaphores[i].curr_procs -= 1;
8010446f:	83 e8 01             	sub    $0x1,%eax
80104472:	89 83 c4 3e 11 80    	mov    %eax,-0x7feec13c(%ebx)
  if (semaphores[i].queue[0] == 0)
80104478:	8d 04 b6             	lea    (%esi,%esi,4),%eax
8010447b:	c1 e0 06             	shl    $0x6,%eax
8010447e:	8b 80 00 3f 11 80    	mov    -0x7feec100(%eax),%eax
80104484:	89 c1                	mov    %eax,%ecx
80104486:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for (j = 0; j < NPROC - 1; j++) {
80104489:	31 c0                	xor    %eax,%eax
  if (semaphores[i].queue[0] == 0)
8010448b:	85 c9                	test   %ecx,%ecx
8010448d:	75 15                	jne    801044a4 <sem_release+0x64>
8010448f:	eb 5a                	jmp    801044eb <sem_release+0xab>
80104491:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      semaphores[i].queue[j] = semaphores[i].queue[j+1];
80104498:	89 94 83 fc 3e 11 80 	mov    %edx,-0x7feec104(%ebx,%eax,4)
  for (j = 0; j < NPROC - 1; j++) {
8010449f:	83 f8 3f             	cmp    $0x3f,%eax
801044a2:	74 25                	je     801044c9 <sem_release+0x89>
    if (semaphores[i].queue[j+1] != 0)
801044a4:	89 c1                	mov    %eax,%ecx
801044a6:	83 c0 01             	add    $0x1,%eax
801044a9:	8b 94 83 00 3f 11 80 	mov    -0x7feec100(%ebx,%eax,4),%edx
801044b0:	85 d2                	test   %edx,%edx
801044b2:	75 e4                	jne    80104498 <sem_release+0x58>
      semaphores[i].queue[j] = 0;
801044b4:	8d 04 b6             	lea    (%esi,%esi,4),%eax
801044b7:	c1 e0 04             	shl    $0x4,%eax
801044ba:	8d 44 01 10          	lea    0x10(%ecx,%eax,1),%eax
801044be:	c7 04 85 c0 3e 11 80 	movl   $0x0,-0x7feec140(,%eax,4)
801044c5:	00 00 00 00 
  p = pop_sem_queue(i);
  release(&(semaphores[i].lock));
801044c9:	83 ec 0c             	sub    $0xc,%esp
801044cc:	57                   	push   %edi
801044cd:	e8 ce 05 00 00       	call   80104aa0 <release>
  if (p != 0) {
    wakeup(p);
801044d2:	58                   	pop    %eax
801044d3:	ff 75 e4             	pushl  -0x1c(%ebp)
801044d6:	e8 05 fc ff ff       	call   801040e0 <wakeup>
...
801044e1:	b8 01 00 00 00       	mov    $0x1,%eax
801044e6:	5b                   	pop    %ebx
801044e7:	5e                   	pop    %esi
801044e8:	5f                   	pop    %edi
801044e9:	5d                   	pop    %ebp
...
801044ee:	57                   	push   %edi
801044ef:	e8 ac 05 00 00       	call   80104aa0 <release>
801044f4:	83 c4 10             	add    $0x10,%esp
801044f7:	eb e5                	jmp    801044de <sem_release+0x9e>
...
80104507:	83 ec 10             	sub    $0x10,%esp
8010450a:	8b 55 08             	mov    0x8(%ebp),%edx
  mutexes[i].curr_pid = 0;
8010450d:	89 d0                	mov    %edx,%eax
  mutexes[i].waiting = -1;
  initlock(&(mutexes[i].lock), (char*)i + '0');
8010450f:	83 c2 30             	add    $0x30,%edx
  mutexes[i].curr_pid = 0;
80104512:	c1 e0 06             	shl    $0x6,%eax
  initlock(&(mutexes[i].lock), (char*)i + '0');
80104515:	52                   	push   %edx
  mutexes[i].curr_pid = 0;
80104516:	c7 80 00 45 11 80 00 	movl   $0x0,-0x7feebb00(%eax)
8010451d:	00 00 00 
  mutexes[i].waiting = -1;
80104520:	c7 80 3c 45 11 80 ff 	movl   $0xffffffff,-0x7feebac4(%eax)
80104527:	ff ff ff 
  initlock(&(mutexes[i].lock), (char*)i + '0');
8010452a:	05 04 45 11 80       	add    $0x80114504,%eax
8010452f:	50                   	push   %eax
80104530:	e8 eb 02 00 00       	call   80104820 <initlock>
  return 1;
}
80104535:	b8 01 00 00 00       	mov    $0x1,%eax
8010453a:	c9                   	leave  
8010453b:	c3                   	ret    
8010453c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80104540 <mutex_acquire>:

int mutex_acquire(int i)
{
...
8010454a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
8010454d:	e8 5e 03 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80104552:	e8 79 f3 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80104557:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010455d:	89 c7                	mov    %eax,%edi
8010455f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  popcli();
80104562:	e8 99 03 00 00       	call   80104900 <popcli>
  struct proc* p = myproc();
  
  if (p->pid == mutexes[i].curr_pid) {
80104567:	8b 45 08             	mov    0x8(%ebp),%eax
8010456a:	8b 77 10             	mov    0x10(%edi),%esi
    return 0;
8010456d:	31 d2                	xor    %edx,%edx
  if (p->pid == mutexes[i].curr_pid) {
8010456f:	c1 e0 06             	shl    $0x6,%eax
80104572:	8b 88 00 45 11 80    	mov    -0x7feebb00(%eax),%ecx
80104578:	39 ce                	cmp    %ecx,%esi
8010457a:	0f 84 84 00 00 00    	je     80104604 <mutex_acquire+0xc4>
  }
  else if(mutexes[i].curr_pid == 0){
80104580:	85 c9                	test   %ecx,%ecx
80104582:	0f 84 88 00 00 00    	je     80104610 <mutex_acquire+0xd0>
    mutexes[i].curr_pid = p->pid;
    cprintf("inja\n");
  }
  else {
    acquire(&(mutexes[i].lock));
80104588:	8d b0 04 45 11 80    	lea    -0x7feebafc(%eax),%esi
8010458e:	83 ec 0c             	sub    $0xc,%esp
80104591:	8d 98 00 45 11 80    	lea    -0x7feebb00(%eax),%ebx
80104597:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010459a:	56                   	push   %esi
8010459b:	e8 10 04 00 00       	call   801049b0 <acquire>
    mutexes[i].waiting = 1;
    while(mutexes[i].curr_pid != 0)
801045a0:	8b 45 e0             	mov    -0x20(%ebp),%eax
    mutexes[i].waiting = 1;
801045a3:	c7 43 3c 01 00 00 00 	movl   $0x1,0x3c(%ebx)
    while(mutexes[i].curr_pid != 0)
801045aa:	83 c4 10             	add    $0x10,%esp
801045ad:	8b 90 00 45 11 80    	mov    -0x7feebb00(%eax),%edx
801045b3:	89 c7                	mov    %eax,%edi
801045b5:	85 d2                	test   %edx,%edx
801045b7:	74 1e                	je     801045d7 <mutex_acquire+0x97>
801045b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      sleep(&mutexes[i], &(mutexes[i].lock));
801045c0:	83 ec 08             	sub    $0x8,%esp
801045c3:	56                   	push   %esi
801045c4:	53                   	push   %ebx
801045c5:	e8 56 f9 ff ff       	call   80103f20 <sleep>
    while(mutexes[i].curr_pid != 0)
801045ca:	8b 87 00 45 11 80    	mov    -0x7feebb00(%edi),%eax
801045d0:	83 c4 10             	add    $0x10,%esp
801045d3:	85 c0                	test   %eax,%eax
801045d5:	75 e9                	jne    801045c0 <mutex_acquire+0x80>
    mutexes[i].curr_pid = p->pid;
801045d7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    mutexes[i].waiting = -1;
    release(&(mutexes[i].lock));
801045da:	83 ec 0c             	sub    $0xc,%esp
    mutexes[i].curr_pid = p->pid;
801045dd:	8b 50 10             	mov    0x10(%eax),%edx
801045e0:	8b 45 08             	mov    0x8(%ebp),%eax
    release(&(mutexes[i].lock));
801045e3:	56                   	push   %esi
    mutexes[i].curr_pid = p->pid;
801045e4:	c1 e0 06             	shl    $0x6,%eax
801045e7:	89 90 00 45 11 80    	mov    %edx,-0x7feebb00(%eax)
    mutexes[i].waiting = -1;
801045ed:	c7 80 3c 45 11 80 ff 	movl   $0xffffffff,-0x7feebac4(%eax)
801045f4:	ff ff ff 
    release(&(mutexes[i].lock));
801045f7:	e8 a4 04 00 00       	call   80104aa0 <release>
801045fc:	83 c4 10             	add    $0x10,%esp
  }
  
  return 1;
801045ff:	ba 01 00 00 00       	mov    $0x1,%edx
}
80104604:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80104610:	83 ec 0c             	sub    $0xc,%esp
    mutexes[i].curr_pid = p->pid;
80104613:	89 b0 00 45 11 80    	mov    %esi,-0x7feebb00(%eax)
    cprintf("inja\n");
80104619:	68 58 7c 10 80       	push   $0x80107c58
8010461e:	e8 8d c0 ff ff       	call   801006b0 <cprintf>
80104623:	83 c4 10             	add    $0x10,%esp
  return 1;
80104626:	ba 01 00 00 00       	mov    $0x1,%edx
}
...
80104640 <mutex_release>:

int mutex_release(int i)
{
...
8010464d:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80104650:	e8 5b 02 00 00       	call   801048b0 <pushcli>
  c = mycpu();
80104655:	e8 76 f2 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
8010465a:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104660:	e8 9b 02 00 00       	call   80104900 <popcli>
  struct proc* p = myproc();
  if (p->pid != mutexes[i].curr_pid)
80104665:	89 f0                	mov    %esi,%eax
80104667:	31 d2                	xor    %edx,%edx
80104669:	c1 e0 06             	shl    $0x6,%eax
8010466c:	8b 88 00 45 11 80    	mov    -0x7feebb00(%eax),%ecx
80104672:	39 4b 10             	cmp    %ecx,0x10(%ebx)
80104675:	74 11                	je     80104688 <mutex_release+0x48>
    }
    mutexes[i].curr_pid = 0;
    release(&(mutexes[i].lock));
  }
  return 1;
80104677:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010467a:	89 d0                	mov    %edx,%eax
8010467c:	5b                   	pop    %ebx
8010467d:	5e                   	pop    %esi
8010467e:	5f                   	pop    %edi
8010467f:	5d                   	pop    %ebp
...
8010468b:	8d 98 04 45 11 80    	lea    -0x7feebafc(%eax),%ebx
80104691:	8d b8 00 45 11 80    	lea    -0x7feebb00(%eax),%edi
80104697:	53                   	push   %ebx
80104698:	e8 13 03 00 00       	call   801049b0 <acquire>
    if(mutexes[i].waiting == 1){
8010469d:	83 c4 10             	add    $0x10,%esp
801046a0:	83 7f 3c 01          	cmpl   $0x1,0x3c(%edi)
801046a4:	74 2a                	je     801046d0 <mutex_release+0x90>
    release(&(mutexes[i].lock));
801046a6:	83 ec 0c             	sub    $0xc,%esp
    mutexes[i].curr_pid = 0;
801046a9:	c1 e6 06             	shl    $0x6,%esi
    release(&(mutexes[i].lock));
801046ac:	53                   	push   %ebx
    mutexes[i].curr_pid = 0;
801046ad:	c7 86 00 45 11 80 00 	movl   $0x0,-0x7feebb00(%esi)
801046b4:	00 00 00 
    release(&(mutexes[i].lock));
801046b7:	e8 e4 03 00 00       	call   80104aa0 <release>
  return 1;
801046bc:	83 c4 10             	add    $0x10,%esp
801046bf:	ba 01 00 00 00       	mov    $0x1,%edx
801046c4:	8d 65 f4             	lea    -0xc(%ebp),%esp
801046c7:	5b                   	pop    %ebx
...
801046d4:	e8 07 fa ff ff       	call   801040e0 <wakeup>
801046d9:	83 c4 10             	add    $0x10,%esp
801046dc:	eb c8                	jmp    801046a6 <mutex_release+0x66>
...
801046ee:	68 c8 7c 10 80       	push   $0x80107cc8
801046f3:	8d 43 04             	lea    0x4(%ebx),%eax
801046f6:	50                   	push   %eax
801046f7:	e8 24 01 00 00       	call   80104820 <initlock>
  lk->name = name;
...
80104705:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104708:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  lk->name = name;
8010470f:	89 43 3c             	mov    %eax,0x3c(%ebx)
}
80104712:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104715:	c9                   	leave  
80104716:	c3                   	ret    
...
80104733:	e8 78 02 00 00       	call   801049b0 <acquire>
  while (lk->locked) {
80104738:	8b 13                	mov    (%ebx),%edx
8010473a:	83 c4 10             	add    $0x10,%esp
8010473d:	85 d2                	test   %edx,%edx
8010473f:	74 1a                	je     8010475b <acquiresleep+0x3b>
80104741:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104748:	83 ec 08             	sub    $0x8,%esp
8010474b:	56                   	push   %esi
8010474c:	53                   	push   %ebx
8010474d:	e8 ce f7 ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
80104752:	8b 03                	mov    (%ebx),%eax
80104754:	83 c4 10             	add    $0x10,%esp
80104757:	85 c0                	test   %eax,%eax
80104759:	75 ed                	jne    80104748 <acquiresleep+0x28>
  }
  lk->locked = 1;
8010475b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104761:	e8 fa f1 ff ff       	call   80103960 <myproc>
80104766:	8b 40 10             	mov    0x10(%eax),%eax
80104769:	89 43 40             	mov    %eax,0x40(%ebx)
  release(&lk->lk);
8010476c:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80104774:	5d                   	pop    %ebp
  release(&lk->lk);
80104775:	e9 26 03 00 00       	jmp    80104aa0 <release>
...
80104789:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
8010478c:	8d 73 04             	lea    0x4(%ebx),%esi
8010478f:	83 ec 0c             	sub    $0xc,%esp
80104792:	56                   	push   %esi
80104793:	e8 18 02 00 00       	call   801049b0 <acquire>
  lk->locked = 0;
80104798:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010479e:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  wakeup(lk);
801047a5:	89 1c 24             	mov    %ebx,(%esp)
801047a8:	e8 33 f9 ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
801047ad:	89 75 08             	mov    %esi,0x8(%ebp)
...
801047b8:	5d                   	pop    %ebp
  release(&lk->lk);
801047b9:	e9 e2 02 00 00       	jmp    80104aa0 <release>
...
801047c8:	31 ff                	xor    %edi,%edi
801047ca:	56                   	push   %esi
801047cb:	53                   	push   %ebx
801047cc:	83 ec 18             	sub    $0x18,%esp
801047cf:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
801047d2:	8d 73 04             	lea    0x4(%ebx),%esi
801047d5:	56                   	push   %esi
801047d6:	e8 d5 01 00 00       	call   801049b0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801047db:	8b 03                	mov    (%ebx),%eax
801047dd:	83 c4 10             	add    $0x10,%esp
801047e0:	85 c0                	test   %eax,%eax
801047e2:	75 1c                	jne    80104800 <holdingsleep+0x40>
  release(&lk->lk);
801047e4:	83 ec 0c             	sub    $0xc,%esp
801047e7:	56                   	push   %esi
801047e8:	e8 b3 02 00 00       	call   80104aa0 <release>
  return r;
}
801047ed:	8d 65 f4             	lea    -0xc(%ebp),%esp
801047f0:	89 f8                	mov    %edi,%eax
801047f2:	5b                   	pop    %ebx
801047f3:	5e                   	pop    %esi
801047f4:	5f                   	pop    %edi
801047f5:	5d                   	pop    %ebp
...
801047fe:	66 90                	xchg   %ax,%ax
  r = lk->locked && (lk->pid == myproc()->pid);
80104800:	8b 5b 40             	mov    0x40(%ebx),%ebx
80104803:	e8 58 f1 ff ff       	call   80103960 <myproc>
80104808:	39 58 10             	cmp    %ebx,0x10(%eax)
8010480b:	0f 94 c0             	sete   %al
8010480e:	0f b6 c0             	movzbl %al,%eax
80104811:	89 c7                	mov    %eax,%edi
80104813:	eb cf                	jmp    801047e4 <holdingsleep+0x24>
80104815:	66 90                	xchg   %ax,%ax
...
80104827:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
8010482a:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
8010482d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
80104833:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80104836:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  lk->lock_holder_pid = -1;
8010483d:	c7 40 34 ff ff ff ff 	movl   $0xffffffff,0x34(%eax)
...
{
8010485d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
80104860:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
80104863:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104867:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104868:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
8010486e:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104874:	77 1a                	ja     80104890 <getcallerpcs+0x40>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104876:	8b 58 04             	mov    0x4(%eax),%ebx
80104879:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010487c:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
8010487f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104881:	83 fa 0a             	cmp    $0xa,%edx
80104884:	75 e2                	jne    80104868 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80104889:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80104890:	8d 04 91             	lea    (%ecx,%edx,4),%eax
80104893:	8d 51 28             	lea    0x28(%ecx),%edx
...
801048ab:	75 f3                	jne    801048a0 <getcallerpcs+0x50>
}
801048ad:	5b                   	pop    %ebx
801048ae:	5d                   	pop    %ebp
801048af:	c3                   	ret    
...
801048bd:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801048be:	e8 0d f0 ff ff       	call   801038d0 <mycpu>
801048c3:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801048c9:	85 c0                	test   %eax,%eax
801048cb:	74 13                	je     801048e0 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801048cd:	e8 fe ef ff ff       	call   801038d0 <mycpu>
801048d2:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
801048df:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
801048e0:	e8 eb ef ff ff       	call   801038d0 <mycpu>
801048e5:	81 e3 00 02 00 00    	and    $0x200,%ebx
801048eb:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
801048f1:	eb da                	jmp    801048cd <pushcli+0x1d>
...
8010490b:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010490c:	f6 c4 02             	test   $0x2,%ah
8010490f:	75 31                	jne    80104942 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80104911:	e8 ba ef ff ff       	call   801038d0 <mycpu>
80104916:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
8010491d:	78 30                	js     8010494f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010491f:	e8 ac ef ff ff       	call   801038d0 <mycpu>
80104924:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010492a:	85 d2                	test   %edx,%edx
8010492c:	74 02                	je     80104930 <popcli+0x30>
    sti();
}
8010492e:	c9                   	leave  
8010492f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104930:	e8 9b ef ff ff       	call   801038d0 <mycpu>
80104935:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010493b:	85 c0                	test   %eax,%eax
8010493d:	74 ef                	je     8010492e <popcli+0x2e>
  asm volatile("sti");
8010493f:	fb                   	sti    
}
80104940:	c9                   	leave  
...
80104945:	68 d3 7c 10 80       	push   $0x80107cd3
8010494a:	e8 41 ba ff ff       	call   80100390 <panic>
    panic("popcli");
8010494f:	83 ec 0c             	sub    $0xc,%esp
80104952:	68 ea 7c 10 80       	push   $0x80107cea
...
8010496c:	31 db                	xor    %ebx,%ebx
  pushcli();
8010496e:	e8 3d ff ff ff       	call   801048b0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104973:	8b 06                	mov    (%esi),%eax
80104975:	85 c0                	test   %eax,%eax
80104977:	75 0f                	jne    80104988 <holding+0x28>
  popcli();
80104979:	e8 82 ff ff ff       	call   80104900 <popcli>
}
...
80104984:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  r = lock->locked && lock->cpu == mycpu();
80104988:	8b 5e 08             	mov    0x8(%esi),%ebx
8010498b:	e8 40 ef ff ff       	call   801038d0 <mycpu>
80104990:	39 c3                	cmp    %eax,%ebx
80104992:	0f 94 c3             	sete   %bl
  popcli();
80104995:	e8 66 ff ff ff       	call   80104900 <popcli>
  r = lock->locked && lock->cpu == mycpu();
8010499a:	0f b6 db             	movzbl %bl,%ebx
}
...
801049b8:	be 01 00 00 00       	mov    $0x1,%esi
801049bd:	53                   	push   %ebx
  pushcli(); // disable interrupts to avoid deadlock.
801049be:	e8 ed fe ff ff       	call   801048b0 <pushcli>
  if (myproc() != NULL)
801049c3:	e8 98 ef ff ff       	call   80103960 <myproc>
801049c8:	85 c0                	test   %eax,%eax
801049ca:	74 08                	je     801049d4 <acquire+0x24>
    cur_proc_pid = myproc()->pid;
801049cc:	e8 8f ef ff ff       	call   80103960 <myproc>
801049d1:	8b 70 10             	mov    0x10(%eax),%esi
...
801049db:	e8 80 ff ff ff       	call   80104960 <holding>
801049e0:	83 c4 10             	add    $0x10,%esp
801049e3:	85 c0                	test   %eax,%eax
801049e5:	74 09                	je     801049f0 <acquire+0x40>
801049e7:	39 73 34             	cmp    %esi,0x34(%ebx)
801049ea:	0f 84 a4 00 00 00    	je     80104a94 <acquire+0xe4>
  if(holding(lk) && lk->lock_holder_pid !=  cur_proc_pid)
801049f0:	83 ec 0c             	sub    $0xc,%esp
801049f3:	53                   	push   %ebx
801049f4:	e8 67 ff ff ff       	call   80104960 <holding>
801049f9:	83 c4 10             	add    $0x10,%esp
801049fc:	85 c0                	test   %eax,%eax
801049fe:	75 60                	jne    80104a60 <acquire+0xb0>
80104a00:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80104a03:	b9 01 00 00 00       	mov    $0x1,%ecx
80104a08:	eb 08                	jmp    80104a12 <acquire+0x62>
80104a0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104a10:	89 d3                	mov    %edx,%ebx
80104a12:	89 c8                	mov    %ecx,%eax
80104a14:	f0 87 03             	lock xchg %eax,(%ebx)
  while(xchg(&lk->locked, 1) != 0)
80104a17:	85 c0                	test   %eax,%eax
80104a19:	75 f5                	jne    80104a10 <acquire+0x60>
  lk-> lock_holder_pid = cur_proc_pid;
80104a1b:	89 72 34             	mov    %esi,0x34(%edx)
  __sync_synchronize();
80104a1e:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104a23:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104a26:	e8 a5 ee ff ff       	call   801038d0 <mycpu>
  ebp = (uint*)v - 2;
80104a2b:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
80104a2d:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
80104a30:	31 c0                	xor    %eax,%eax
80104a32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104a38:	8d 8a 00 00 00 80    	lea    -0x80000000(%edx),%ecx
80104a3e:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
80104a44:	77 32                	ja     80104a78 <acquire+0xc8>
    pcs[i] = ebp[1];     // saved %eip
80104a46:	8b 4a 04             	mov    0x4(%edx),%ecx
80104a49:	89 4c 83 0c          	mov    %ecx,0xc(%ebx,%eax,4)
  for(i = 0; i < 10; i++){
80104a4d:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80104a50:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80104a52:	83 f8 0a             	cmp    $0xa,%eax
80104a55:	75 e1                	jne    80104a38 <acquire+0x88>
}
...
80104a5e:	66 90                	xchg   %ax,%ax
  if(holding(lk) && lk->lock_holder_pid !=  cur_proc_pid)
80104a60:	39 73 34             	cmp    %esi,0x34(%ebx)
80104a63:	74 9b                	je     80104a00 <acquire+0x50>
    panic("acquire");
80104a65:	83 ec 0c             	sub    $0xc,%esp
80104a68:	68 f1 7c 10 80       	push   $0x80107cf1
80104a6d:	e8 1e b9 ff ff       	call   80100390 <panic>
80104a72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(; i < 10; i++)
80104a78:	8d 44 83 0c          	lea    0xc(%ebx,%eax,4),%eax
80104a7c:	83 c3 34             	add    $0x34,%ebx
80104a7f:	90                   	nop
    pcs[i] = 0;
...
80104a8b:	75 f3                	jne    80104a80 <acquire+0xd0>
}
...
80104a93:	c3                   	ret    
    popcli();
80104a94:	e8 67 fe ff ff       	call   80104900 <popcli>
    return;
80104a99:	eb bc                	jmp    80104a57 <acquire+0xa7>
...
80104aaf:	e8 ac fe ff ff       	call   80104960 <holding>
80104ab4:	83 c4 10             	add    $0x10,%esp
80104ab7:	85 c0                	test   %eax,%eax
80104ab9:	74 29                	je     80104ae4 <release+0x44>
  lk->pcs[0] = 0;
80104abb:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104ac2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  lk->lock_holder_pid = -1;
80104ac9:	c7 43 34 ff ff ff ff 	movl   $0xffffffff,0x34(%ebx)
  __sync_synchronize();
80104ad0:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104ad5:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104adb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104ade:	c9                   	leave  
  popcli();
80104adf:	e9 1c fe ff ff       	jmp    80104900 <popcli>
    panic("release");
80104ae4:	83 ec 0c             	sub    $0xc,%esp
80104ae7:	68 f9 7c 10 80       	push   $0x80107cf9
80104aec:	e8 9f b8 ff ff       	call   80100390 <panic>
80104af1:	66 90                	xchg   %ax,%ax
80104af3:	66 90                	xchg   %ax,%ax
...
80104b14:	09 cf                	or     %ecx,%edi
80104b16:	83 e7 03             	and    $0x3,%edi
80104b19:	75 25                	jne    80104b40 <memset+0x40>
    c &= 0xFF;
80104b1b:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104b1e:	c1 e0 18             	shl    $0x18,%eax
80104b21:	89 fb                	mov    %edi,%ebx
80104b23:	c1 e9 02             	shr    $0x2,%ecx
...
80104b40:	89 d7                	mov    %edx,%edi
80104b42:	fc                   	cld    
80104b43:	f3 aa                	rep stos %al,%es:(%edi)
80104b45:	5b                   	pop    %ebx
...
80104b58:	8b 75 10             	mov    0x10(%ebp),%esi
...
80104b5f:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  s2 = v2;
  while(n-- > 0){
80104b62:	85 f6                	test   %esi,%esi
80104b64:	74 2a                	je     80104b90 <memcmp+0x40>
80104b66:	01 c6                	add    %eax,%esi
80104b68:	eb 10                	jmp    80104b7a <memcmp+0x2a>
...
80104b78:	74 16                	je     80104b90 <memcmp+0x40>
    if(*s1 != *s2)
80104b7a:	0f b6 0a             	movzbl (%edx),%ecx
80104b7d:	0f b6 18             	movzbl (%eax),%ebx
...
80104baf:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104bb2:	39 d6                	cmp    %edx,%esi
80104bb4:	73 2a                	jae    80104be0 <memmove+0x40>
80104bb6:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104bb9:	39 fa                	cmp    %edi,%edx
80104bbb:	73 23                	jae    80104be0 <memmove+0x40>
80104bbd:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104bc0:	85 c9                	test   %ecx,%ecx
80104bc2:	74 13                	je     80104bd7 <memmove+0x37>
80104bc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
80104bc8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104bcc:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80104bcf:	83 e8 01             	sub    $0x1,%eax
80104bd2:	83 f8 ff             	cmp    $0xffffffff,%eax
80104bd5:	75 f1                	jne    80104bc8 <memmove+0x28>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80104bdd:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
80104be0:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
80104be3:	89 d7                	mov    %edx,%edi
80104be5:	85 c9                	test   %ecx,%ecx
80104be7:	74 ee                	je     80104bd7 <memmove+0x37>
80104be9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104bf0:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104bf1:	39 f0                	cmp    %esi,%eax
80104bf3:	75 fb                	jne    80104bf0 <memmove+0x50>
}
80104bf5:	5e                   	pop    %esi
...
80104c24:	74 32                	je     80104c58 <strncmp+0x48>
80104c26:	01 c6                	add    %eax,%esi
80104c28:	eb 14                	jmp    80104c3e <strncmp+0x2e>
80104c2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104c30:	38 da                	cmp    %bl,%dl
80104c32:	75 14                	jne    80104c48 <strncmp+0x38>
    n--, p++, q++;
80104c34:	83 c0 01             	add    $0x1,%eax
80104c37:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104c3a:	39 f0                	cmp    %esi,%eax
80104c3c:	74 1a                	je     80104c58 <strncmp+0x48>
80104c3e:	0f b6 11             	movzbl (%ecx),%edx
80104c41:	0f b6 18             	movzbl (%eax),%ebx
80104c44:	84 d2                	test   %dl,%dl
80104c46:	75 e8                	jne    80104c30 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104c48:	0f b6 c2             	movzbl %dl,%eax
80104c4b:	29 d8                	sub    %ebx,%eax
}
80104c4d:	5b                   	pop    %ebx
80104c4e:	5e                   	pop    %esi
80104c4f:	5d                   	pop    %ebp
...
80104c68:	56                   	push   %esi
80104c69:	8b 75 08             	mov    0x8(%ebp),%esi
80104c6c:	53                   	push   %ebx
80104c6d:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104c70:	89 f2                	mov    %esi,%edx
80104c72:	eb 1b                	jmp    80104c8f <strncpy+0x2f>
80104c74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104c78:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104c7c:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104c7f:	83 c2 01             	add    $0x1,%edx
80104c82:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80104c86:	89 f9                	mov    %edi,%ecx
80104c88:	88 4a ff             	mov    %cl,-0x1(%edx)
80104c8b:	84 c9                	test   %cl,%cl
80104c8d:	74 09                	je     80104c98 <strncpy+0x38>
80104c8f:	89 c3                	mov    %eax,%ebx
80104c91:	83 e8 01             	sub    $0x1,%eax
80104c94:	85 db                	test   %ebx,%ebx
80104c96:	7f e0                	jg     80104c78 <strncpy+0x18>
    ;
  while(n-- > 0)
80104c98:	89 d1                	mov    %edx,%ecx
80104c9a:	85 c0                	test   %eax,%eax
80104c9c:	7e 15                	jle    80104cb3 <strncpy+0x53>
80104c9e:	66 90                	xchg   %ax,%ax
    *s++ = 0;
80104ca0:	83 c1 01             	add    $0x1,%ecx
80104ca3:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
80104ca7:	89 c8                	mov    %ecx,%eax
80104ca9:	f7 d0                	not    %eax
80104cab:	01 d0                	add    %edx,%eax
80104cad:	01 d8                	add    %ebx,%eax
80104caf:	85 c0                	test   %eax,%eax
80104cb1:	7f ed                	jg     80104ca0 <strncpy+0x40>
  return os;
}
80104cb3:	5b                   	pop    %ebx
80104cb4:	89 f0                	mov    %esi,%eax
80104cb6:	5e                   	pop    %esi
80104cb7:	5f                   	pop    %edi
80104cb8:	5d                   	pop    %ebp
80104cb9:	c3                   	ret    
...
80104cc8:	8b 55 10             	mov    0x10(%ebp),%edx
80104ccb:	8b 75 08             	mov    0x8(%ebp),%esi
...
80104cd4:	7e 21                	jle    80104cf7 <safestrcpy+0x37>
80104cd6:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80104cda:	89 f2                	mov    %esi,%edx
80104cdc:	eb 12                	jmp    80104cf0 <safestrcpy+0x30>
...
80104d09:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
80104d0c:	80 3a 00             	cmpb   $0x0,(%edx)
80104d0f:	74 10                	je     80104d21 <strlen+0x21>
80104d11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104d18:	83 c0 01             	add    $0x1,%eax
80104d1b:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80104d1f:	75 f7                	jne    80104d18 <strlen+0x18>
    ;
  return n;
}
80104d21:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104d23:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104d27:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104d2c:	53                   	push   %ebx
  pushl %esi
80104d2d:	56                   	push   %esi
  pushl %edi
80104d2e:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80104d2f:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104d31:	89 d4                	mov    %edx,%esp
...
80104d4b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104d4e:	e8 0d ec ff ff       	call   80103960 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104d53:	8b 00                	mov    (%eax),%eax
80104d55:	39 d8                	cmp    %ebx,%eax
80104d57:	76 17                	jbe    80104d70 <fetchint+0x30>
80104d59:	8d 53 04             	lea    0x4(%ebx),%edx
80104d5c:	39 d0                	cmp    %edx,%eax
80104d5e:	72 10                	jb     80104d70 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104d60:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d63:	8b 13                	mov    (%ebx),%edx
...
80104d75:	eb f2                	jmp    80104d69 <fetchint+0x29>
...
80104d8e:	e8 cd eb ff ff       	call   80103960 <myproc>
  ...
  if(addr >= curproc->sz)
80104d93:	39 18                	cmp    %ebx,(%eax)
80104d95:	76 31                	jbe    80104dc8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
...
80104da0:	73 26                	jae    80104dc8 <fetchstr+0x48>
80104da2:	89 d8                	mov    %ebx,%eax
80104da4:	eb 11                	jmp    80104db7 <fetchstr+0x37>
...
80104db5:	76 11                	jbe    80104dc8 <fetchstr+0x48>
    if(*s == 0)
80104db7:	80 38 00             	cmpb   $0x0,(%eax)
80104dba:	75 f4                	jne    80104db0 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
80104dbc:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
...
80104de9:	e8 72 eb ff ff       	call   80103960 <myproc>
80104dee:	8b 55 08             	mov    0x8(%ebp),%edx
80104df1:	8b 40 18             	mov    0x18(%eax),%eax
80104df4:	8b 40 44             	mov    0x44(%eax),%eax
80104df7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104dfa:	e8 61 eb ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104dff:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104e02:	8b 00                	mov    (%eax),%eax
80104e04:	39 c6                	cmp    %eax,%esi
80104e06:	73 18                	jae    80104e20 <argint+0x40>
80104e08:	8d 53 08             	lea    0x8(%ebx),%edx
80104e0b:	39 d0                	cmp    %edx,%eax
80104e0d:	72 11                	jb     80104e20 <argint+0x40>
  *ip = *(int*)(addr);
80104e0f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e12:	8b 53 04             	mov    0x4(%ebx),%edx
...
80104e20:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104e25:	eb f2                	jmp    80104e19 <argint+0x39>
...
80104e3c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104e3f:	e8 1c eb ff ff       	call   80103960 <myproc>
 
  if(argint(n, &i) < 0)
80104e44:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104e47:	89 c6                	mov    %eax,%esi
  if(argint(n, &i) < 0)
80104e49:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e4c:	50                   	push   %eax
80104e4d:	ff 75 08             	pushl  0x8(%ebp)
80104e50:	e8 8b ff ff ff       	call   80104de0 <argint>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104e55:	83 c4 10             	add    $0x10,%esp
80104e58:	85 c0                	test   %eax,%eax
80104e5a:	78 24                	js     80104e80 <argptr+0x50>
80104e5c:	85 db                	test   %ebx,%ebx
80104e5e:	78 20                	js     80104e80 <argptr+0x50>
80104e60:	8b 16                	mov    (%esi),%edx
80104e62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e65:	39 c2                	cmp    %eax,%edx
80104e67:	76 17                	jbe    80104e80 <argptr+0x50>
80104e69:	01 c3                	add    %eax,%ebx
80104e6b:	39 da                	cmp    %ebx,%edx
80104e6d:	72 11                	jb     80104e80 <argptr+0x50>
    return -1;
  *pp = (char*)i;
80104e6f:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e72:	89 02                	mov    %eax,(%edx)
  return 0;
80104e74:	31 c0                	xor    %eax,%eax
}
80104e76:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104e79:	5b                   	pop    %ebx
80104e7a:	5e                   	pop    %esi
80104e7b:	5d                   	pop    %ebp
80104e7c:	c3                   	ret    
...
80104e85:	eb ef                	jmp    80104e76 <argptr+0x46>
...
80104e97:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80104e9a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e9d:	50                   	push   %eax
80104e9e:	ff 75 08             	pushl  0x8(%ebp)
80104ea1:	e8 3a ff ff ff       	call   80104de0 <argint>
80104ea6:	83 c4 10             	add    $0x10,%esp
80104ea9:	85 c0                	test   %eax,%eax
80104eab:	78 13                	js     80104ec0 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
80104ead:	83 ec 08             	sub    $0x8,%esp
80104eb0:	ff 75 0c             	pushl  0xc(%ebp)
80104eb3:	ff 75 f4             	pushl  -0xc(%ebp)
80104eb6:	e8 c5 fe ff ff       	call   80104d80 <fetchstr>
...
80104ed8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104edb:	e8 80 ea ff ff       	call   80103960 <myproc>
80104ee0:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104ee2:	8b 40 18             	mov    0x18(%eax),%eax
80104ee5:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ee8:	8d 50 ff             	lea    -0x1(%eax),%edx
80104eeb:	83 fa 1a             	cmp    $0x1a,%edx
80104eee:	77 20                	ja     80104f10 <syscall+0x40>
80104ef0:	8b 14 85 20 7d 10 80 	mov    -0x7fef82e0(,%eax,4),%edx
80104ef7:	85 d2                	test   %edx,%edx
80104ef9:	74 15                	je     80104f10 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104efb:	ff d2                	call   *%edx
80104efd:	89 c2                	mov    %eax,%edx
80104eff:	8b 43 18             	mov    0x18(%ebx),%eax
80104f02:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104f10:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104f11:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104f14:	50                   	push   %eax
80104f15:	ff 73 10             	pushl  0x10(%ebx)
80104f18:	68 01 7d 10 80       	push   $0x80107d01
80104f1d:	e8 8e b7 ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104f22:	8b 43 18             	mov    0x18(%ebx),%eax
...
80104f57:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104f5a:	e8 f1 d0 ff ff       	call   80102050 <nameiparent>
...
80104f7c:	e8 2f cd ff ff       	call   80101cb0 <dirlookup>
...
80104fc4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104fc6:	e8 35 ca ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104fea:	e8 f1 c5 ff ff       	call   801015e0 <ialloc>
...
80105009:	66 89 46 56          	mov    %ax,0x56(%esi)
  ip->minor = minor;
8010500d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80105011:	66 89 46 58          	mov    %ax,0x58(%esi)
  ip->nlink = 1;
80105015:	b8 01 00 00 00       	mov    $0x1,%eax
8010501a:	66 89 46 5a          	mov    %ax,0x5a(%esi)
  iupdate(ip);
8010501e:	89 34 24             	mov    %esi,(%esp)
80105021:	e8 7a c6 ff ff       	call   801016a0 <iupdate>
...
80105033:	ff 76 04             	pushl  0x4(%esi)
80105036:	57                   	push   %edi
80105037:	53                   	push   %ebx
80105038:	e8 33 cf ff ff       	call   80101f70 <dirlink>
...
80105048:	e8 b3 c9 ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80105060:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++;  // for ".."
80105063:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
    iupdate(dp);
80105068:	53                   	push   %ebx
80105069:	e8 32 c6 ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010506e:	83 c4 0c             	add    $0xc,%esp
80105071:	ff 76 04             	pushl  0x4(%esi)
80105074:	68 ac 7d 10 80       	push   $0x80107dac
80105079:	56                   	push   %esi
8010507a:	e8 f1 ce ff ff       	call   80101f70 <dirlink>
...
8010508c:	68 ab 7d 10 80       	push   $0x80107dab
80105091:	56                   	push   %esi
80105092:	e8 d9 ce ff ff       	call   80101f70 <dirlink>
...
801050a1:	68 9f 7d 10 80       	push   $0x80107d9f
801050a6:	e8 e5 b2 ff ff       	call   80100390 <panic>
...
801050bf:	68 ae 7d 10 80       	push   $0x80107dae
801050c4:	e8 c7 b2 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
801050c9:	83 ec 0c             	sub    $0xc,%esp
801050cc:	68 90 7d 10 80       	push   $0x80107d90
...
801050f2:	e8 e9 fc ff ff       	call   80104de0 <argint>
...
80105104:	e8 57 e8 ff ff       	call   80103960 <myproc>
...
8010513e:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80105141:	e8 9a ff ff ff       	call   801050e0 <argfd.constprop.0>
80105146:	85 c0                	test   %eax,%eax
80105148:	78 1e                	js     80105168 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
8010514a:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
8010514d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010514f:	e8 0c e8 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105154:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105158:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
...
8010517d:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80105180:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80105184:	83 ec 0c             	sub    $0xc,%esp
80105187:	ff 75 f4             	pushl  -0xc(%ebp)
8010518a:	e8 e1 bc ff ff       	call   80100e70 <filedup>
  return fd;
...
801051a9:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
801051ac:	8d 55 ec             	lea    -0x14(%ebp),%edx
801051af:	e8 2c ff ff ff       	call   801050e0 <argfd.constprop.0>
801051b4:	85 c0                	test   %eax,%eax
801051b6:	78 48                	js     80105200 <sys_read+0x60>
801051b8:	83 ec 08             	sub    $0x8,%esp
801051bb:	8d 45 f0             	lea    -0x10(%ebp),%eax
801051be:	50                   	push   %eax
801051bf:	6a 02                	push   $0x2
801051c1:	e8 1a fc ff ff       	call   80104de0 <argint>
801051c6:	83 c4 10             	add    $0x10,%esp
801051c9:	85 c0                	test   %eax,%eax
801051cb:	78 33                	js     80105200 <sys_read+0x60>
801051cd:	83 ec 04             	sub    $0x4,%esp
801051d0:	8d 45 f4             	lea    -0xc(%ebp),%eax
801051d3:	ff 75 f0             	pushl  -0x10(%ebp)
801051d6:	50                   	push   %eax
801051d7:	6a 01                	push   $0x1
801051d9:	e8 52 fc ff ff       	call   80104e30 <argptr>
801051de:	83 c4 10             	add    $0x10,%esp
801051e1:	85 c0                	test   %eax,%eax
801051e3:	78 1b                	js     80105200 <sys_read+0x60>
  return fileread(f, p, n);
801051e5:	83 ec 04             	sub    $0x4,%esp
801051e8:	ff 75 f0             	pushl  -0x10(%ebp)
801051eb:	ff 75 f4             	pushl  -0xc(%ebp)
801051ee:	ff 75 ec             	pushl  -0x14(%ebp)
801051f1:	e8 fa bd ff ff       	call   80100ff0 <fileread>
...
80105249:	e8 e2 fb ff ff       	call   80104e30 <argptr>
8010524e:	83 c4 10             	add    $0x10,%esp
80105251:	85 c0                	test   %eax,%eax
80105253:	78 1b                	js     80105270 <sys_write+0x60>
...
80105261:	e8 2a be ff ff       	call   80101090 <filewrite>
...
80105287:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
8010528a:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010528d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105290:	e8 4b fe ff ff       	call   801050e0 <argfd.constprop.0>
80105295:	85 c0                	test   %eax,%eax
80105297:	78 27                	js     801052c0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
...
801052a1:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
801052a4:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
801052ab:	00 
  fileclose(f);
801052ac:	ff 75 f4             	pushl  -0xc(%ebp)
801052af:	e8 0c bc ff ff       	call   80100ec0 <fileclose>
  return 0;
...
801052d9:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
801052dc:	8d 55 f0             	lea    -0x10(%ebp),%edx
801052df:	e8 fc fd ff ff       	call   801050e0 <argfd.constprop.0>
801052e4:	85 c0                	test   %eax,%eax
801052e6:	78 30                	js     80105318 <sys_fstat+0x48>
801052e8:	83 ec 04             	sub    $0x4,%esp
801052eb:	8d 45 f4             	lea    -0xc(%ebp),%eax
801052ee:	6a 14                	push   $0x14
801052f0:	50                   	push   %eax
801052f1:	6a 01                	push   $0x1
801052f3:	e8 38 fb ff ff       	call   80104e30 <argptr>
801052f8:	83 c4 10             	add    $0x10,%esp
801052fb:	85 c0                	test   %eax,%eax
801052fd:	78 19                	js     80105318 <sys_fstat+0x48>
  return filestat(f, st);
801052ff:	83 ec 08             	sub    $0x8,%esp
80105302:	ff 75 f4             	pushl  -0xc(%ebp)
80105305:	ff 75 f0             	pushl  -0x10(%ebp)
80105308:	e8 93 bc ff ff       	call   80100fa0 <filestat>
...
80105329:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
8010532c:	53                   	push   %ebx
8010532d:	83 ec 34             	sub    $0x34,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105330:	50                   	push   %eax
80105331:	6a 00                	push   $0x0
80105333:	e8 58 fb ff ff       	call   80104e90 <argstr>
80105338:	83 c4 10             	add    $0x10,%esp
8010533b:	85 c0                	test   %eax,%eax
8010533d:	0f 88 ff 00 00 00    	js     80105442 <sys_link+0x122>
80105343:	83 ec 08             	sub    $0x8,%esp
80105346:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105349:	50                   	push   %eax
8010534a:	6a 01                	push   $0x1
8010534c:	e8 3f fb ff ff       	call   80104e90 <argstr>
80105351:	83 c4 10             	add    $0x10,%esp
80105354:	85 c0                	test   %eax,%eax
80105356:	0f 88 e6 00 00 00    	js     80105442 <sys_link+0x122>
  begin_op();
8010535c:	e8 cf d9 ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
80105361:	83 ec 0c             	sub    $0xc,%esp
80105364:	ff 75 d4             	pushl  -0x2c(%ebp)
80105367:	e8 c4 cc ff ff       	call   80102030 <namei>
8010536c:	83 c4 10             	add    $0x10,%esp
8010536f:	89 c3                	mov    %eax,%ebx
80105371:	85 c0                	test   %eax,%eax
80105373:	0f 84 e8 00 00 00    	je     80105461 <sys_link+0x141>
  ilock(ip);
...
80105385:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
8010538a:	0f 84 b9 00 00 00    	je     80105449 <sys_link+0x129>
  iupdate(ip);
80105390:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80105393:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105398:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
8010539b:	53                   	push   %ebx
8010539c:	e8 ff c2 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
801053a1:	89 1c 24             	mov    %ebx,(%esp)
801053a4:	e8 97 c4 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801053a9:	58                   	pop    %eax
801053aa:	5a                   	pop    %edx
801053ab:	57                   	push   %edi
801053ac:	ff 75 d0             	pushl  -0x30(%ebp)
801053af:	e8 9c cc ff ff       	call   80102050 <nameiparent>
801053b4:	83 c4 10             	add    $0x10,%esp
801053b7:	89 c6                	mov    %eax,%esi
801053b9:	85 c0                	test   %eax,%eax
801053bb:	74 5f                	je     8010541c <sys_link+0xfc>
  ilock(dp);
801053bd:	83 ec 0c             	sub    $0xc,%esp
801053c0:	50                   	push   %eax
801053c1:	e8 9a c3 ff ff       	call   80101760 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801053c6:	8b 03                	mov    (%ebx),%eax
801053c8:	83 c4 10             	add    $0x10,%esp
801053cb:	39 06                	cmp    %eax,(%esi)
801053cd:	75 41                	jne    80105410 <sys_link+0xf0>
801053cf:	83 ec 04             	sub    $0x4,%esp
801053d2:	ff 73 04             	pushl  0x4(%ebx)
801053d5:	57                   	push   %edi
801053d6:	56                   	push   %esi
801053d7:	e8 94 cb ff ff       	call   80101f70 <dirlink>
801053dc:	83 c4 10             	add    $0x10,%esp
801053df:	85 c0                	test   %eax,%eax
801053e1:	78 2d                	js     80105410 <sys_link+0xf0>
  iunlockput(dp);
801053e3:	83 ec 0c             	sub    $0xc,%esp
801053e6:	56                   	push   %esi
801053e7:	e8 14 c6 ff ff       	call   80101a00 <iunlockput>
  iput(ip);
801053ec:	89 1c 24             	mov    %ebx,(%esp)
801053ef:	e8 9c c4 ff ff       	call   80101890 <iput>
  end_op();
801053f4:	e8 a7 d9 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105414:	e8 e7 c5 ff ff       	call   80101a00 <iunlockput>
    goto bad;
80105419:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
8010541c:	83 ec 0c             	sub    $0xc,%esp
8010541f:	53                   	push   %ebx
80105420:	e8 3b c3 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80105425:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
  iupdate(ip);
8010542a:	89 1c 24             	mov    %ebx,(%esp)
8010542d:	e8 6e c2 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105432:	89 1c 24             	mov    %ebx,(%esp)
80105435:	e8 c6 c5 ff ff       	call   80101a00 <iunlockput>
  end_op();
8010543a:	e8 61 d9 ff ff       	call   80102da0 <end_op>
  return -1;
8010543f:	83 c4 10             	add    $0x10,%esp
80105442:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105447:	eb b5                	jmp    801053fe <sys_link+0xde>
    iunlockput(ip);
80105449:	83 ec 0c             	sub    $0xc,%esp
8010544c:	53                   	push   %ebx
8010544d:	e8 ae c5 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105452:	e8 49 d9 ff ff       	call   80102da0 <end_op>
    return -1;
80105457:	83 c4 10             	add    $0x10,%esp
8010545a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010545f:	eb 9d                	jmp    801053fe <sys_link+0xde>
    end_op();
80105461:	e8 3a d9 ff ff       	call   80102da0 <end_op>
    return -1;
80105466:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010546b:	eb 91                	jmp    801053fe <sys_link+0xde>
...
80105478:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105479:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
8010547c:	53                   	push   %ebx
8010547d:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
80105480:	50                   	push   %eax
80105481:	6a 00                	push   $0x0
80105483:	e8 08 fa ff ff       	call   80104e90 <argstr>
80105488:	83 c4 10             	add    $0x10,%esp
8010548b:	85 c0                	test   %eax,%eax
8010548d:	0f 88 7d 01 00 00    	js     80105610 <sys_unlink+0x1a0>
  begin_op();
80105493:	e8 98 d8 ff ff       	call   80102d30 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105498:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010549b:	83 ec 08             	sub    $0x8,%esp
8010549e:	53                   	push   %ebx
8010549f:	ff 75 c0             	pushl  -0x40(%ebp)
801054a2:	e8 a9 cb ff ff       	call   80102050 <nameiparent>
801054a7:	83 c4 10             	add    $0x10,%esp
801054aa:	89 c6                	mov    %eax,%esi
801054ac:	85 c0                	test   %eax,%eax
801054ae:	0f 84 66 01 00 00    	je     8010561a <sys_unlink+0x1aa>
  ilock(dp);
801054b4:	83 ec 0c             	sub    $0xc,%esp
801054b7:	50                   	push   %eax
801054b8:	e8 a3 c2 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801054bd:	58                   	pop    %eax
801054be:	5a                   	pop    %edx
801054bf:	68 ac 7d 10 80       	push   $0x80107dac
801054c4:	53                   	push   %ebx
801054c5:	e8 c6 c7 ff ff       	call   80101c90 <namecmp>
801054ca:	83 c4 10             	add    $0x10,%esp
801054cd:	85 c0                	test   %eax,%eax
801054cf:	0f 84 03 01 00 00    	je     801055d8 <sys_unlink+0x168>
801054d5:	83 ec 08             	sub    $0x8,%esp
801054d8:	68 ab 7d 10 80       	push   $0x80107dab
801054dd:	53                   	push   %ebx
801054de:	e8 ad c7 ff ff       	call   80101c90 <namecmp>
801054e3:	83 c4 10             	add    $0x10,%esp
801054e6:	85 c0                	test   %eax,%eax
801054e8:	0f 84 ea 00 00 00    	je     801055d8 <sys_unlink+0x168>
...
801054f7:	e8 b4 c7 ff ff       	call   80101cb0 <dirlookup>
801054fc:	83 c4 10             	add    $0x10,%esp
801054ff:	89 c3                	mov    %eax,%ebx
80105501:	85 c0                	test   %eax,%eax
80105503:	0f 84 cf 00 00 00    	je     801055d8 <sys_unlink+0x168>
  ilock(ip);
...
80105515:	66 83 7b 5a 00       	cmpw   $0x0,0x5a(%ebx)
8010551a:	0f 8e 23 01 00 00    	jle    80105643 <sys_unlink+0x1d3>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105520:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80105539:	ff 75 c4             	pushl  -0x3c(%ebp)
8010553c:	57                   	push   %edi
8010553d:	56                   	push   %esi
8010553e:	e8 1d c6 ff ff       	call   80101b60 <writei>
80105543:	83 c4 20             	add    $0x20,%esp
80105546:	83 f8 10             	cmp    $0x10,%eax
80105549:	0f 85 e7 00 00 00    	jne    80105636 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
8010554f:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
80105554:	0f 84 96 00 00 00    	je     801055f0 <sys_unlink+0x180>
  iunlockput(dp);
8010555a:	83 ec 0c             	sub    $0xc,%esp
8010555d:	56                   	push   %esi
8010555e:	e8 9d c4 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
80105563:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
  iupdate(ip);
80105568:	89 1c 24             	mov    %ebx,(%esp)
8010556b:	e8 30 c1 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105570:	89 1c 24             	mov    %ebx,(%esp)
80105573:	e8 88 c4 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
80105582:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105585:	5b                   	pop    %ebx
80105586:	5e                   	pop    %esi
80105587:	5f                   	pop    %edi
80105588:	5d                   	pop    %ebp
...
80105590:	83 7b 5c 20          	cmpl   $0x20,0x5c(%ebx)
80105594:	76 94                	jbe    8010552a <sys_unlink+0xba>
80105596:	ba 20 00 00 00       	mov    $0x20,%edx
8010559b:	eb 0b                	jmp    801055a8 <sys_unlink+0x138>
8010559d:	8d 76 00             	lea    0x0(%esi),%esi
801055a0:	83 c2 10             	add    $0x10,%edx
801055a3:	39 53 5c             	cmp    %edx,0x5c(%ebx)
801055a6:	76 82                	jbe    8010552a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801055a8:	6a 10                	push   $0x10
801055aa:	52                   	push   %edx
801055ab:	57                   	push   %edi
801055ac:	53                   	push   %ebx
801055ad:	89 55 b4             	mov    %edx,-0x4c(%ebp)
801055b0:	e8 ab c4 ff ff       	call   80101a60 <readi>
801055b5:	83 c4 10             	add    $0x10,%esp
801055b8:	8b 55 b4             	mov    -0x4c(%ebp),%edx
801055bb:	83 f8 10             	cmp    $0x10,%eax
801055be:	75 69                	jne    80105629 <sys_unlink+0x1b9>
    if(de.inum != 0)
801055c0:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801055c5:	74 d9                	je     801055a0 <sys_unlink+0x130>
    iunlockput(ip);
801055c7:	83 ec 0c             	sub    $0xc,%esp
801055ca:	53                   	push   %ebx
801055cb:	e8 30 c4 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
801055dc:	e8 1f c4 ff ff       	call   80101a00 <iunlockput>
  end_op();
801055e1:	e8 ba d7 ff ff       	call   80102da0 <end_op>
  return -1;
801055e6:	83 c4 10             	add    $0x10,%esp
801055e9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055ee:	eb 92                	jmp    80105582 <sys_unlink+0x112>
    iupdate(dp);
801055f0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801055f3:	66 83 6e 5a 01       	subw   $0x1,0x5a(%esi)
    iupdate(dp);
801055f8:	56                   	push   %esi
801055f9:	e8 a2 c0 ff ff       	call   801016a0 <iupdate>
801055fe:	83 c4 10             	add    $0x10,%esp
80105601:	e9 54 ff ff ff       	jmp    8010555a <sys_unlink+0xea>
...
80105615:	e9 68 ff ff ff       	jmp    80105582 <sys_unlink+0x112>
    end_op();
8010561a:	e8 81 d7 ff ff       	call   80102da0 <end_op>
    return -1;
8010561f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105624:	e9 59 ff ff ff       	jmp    80105582 <sys_unlink+0x112>
      panic("isdirempty: readi");
80105629:	83 ec 0c             	sub    $0xc,%esp
8010562c:	68 d0 7d 10 80       	push   $0x80107dd0
80105631:	e8 5a ad ff ff       	call   80100390 <panic>
    panic("unlink: writei");
80105636:	83 ec 0c             	sub    $0xc,%esp
80105639:	68 e2 7d 10 80       	push   $0x80107de2
8010563e:	e8 4d ad ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
80105643:	83 ec 0c             	sub    $0xc,%esp
80105646:	68 be 7d 10 80       	push   $0x80107dbe
8010564b:	e8 40 ad ff ff       	call   80100390 <panic>
...
80105659:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
...
80105663:	e8 28 f8 ff ff       	call   80104e90 <argstr>
80105668:	83 c4 10             	add    $0x10,%esp
8010566b:	85 c0                	test   %eax,%eax
8010566d:	0f 88 8a 00 00 00    	js     801056fd <sys_open+0xad>
80105673:	83 ec 08             	sub    $0x8,%esp
80105676:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105679:	50                   	push   %eax
8010567a:	6a 01                	push   $0x1
8010567c:	e8 5f f7 ff ff       	call   80104de0 <argint>
80105681:	83 c4 10             	add    $0x10,%esp
80105684:	85 c0                	test   %eax,%eax
80105686:	78 75                	js     801056fd <sys_open+0xad>
    return -1;

  begin_op();
80105688:	e8 a3 d6 ff ff       	call   80102d30 <begin_op>

  if(omode & O_CREATE){
8010568d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105691:	75 75                	jne    80105708 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105699:	e8 92 c9 ff ff       	call   80102030 <namei>
8010569e:	83 c4 10             	add    $0x10,%esp
801056a1:	89 c6                	mov    %eax,%esi
801056a3:	85 c0                	test   %eax,%eax
801056a5:	74 7e                	je     80105725 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
801056ab:	e8 b0 c0 ff ff       	call   80101760 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801056b0:	83 c4 10             	add    $0x10,%esp
801056b3:	66 83 7e 54 01       	cmpw   $0x1,0x54(%esi)
801056b8:	0f 84 c2 00 00 00    	je     80105780 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
80105702:	eb 6d                	jmp    80105771 <sys_open+0x121>
...
80105717:	e8 24 f8 ff ff       	call   80104f40 <create>
    if(ip == 0){
...
8010572f:	eb 40                	jmp    80105771 <sys_open+0x121>
...
80105785:	0f 84 33 ff ff ff    	je     801056be <sys_open+0x6e>
8010578b:	e9 5c ff ff ff       	jmp    801056ec <sys_open+0x9c>
...
801057a8:	e8 e3 f6 ff ff       	call   80104e90 <argstr>
...
801057c3:	e8 78 f7 ff ff       	call   80104f40 <create>
...
80105818:	e8 73 f6 ff ff       	call   80104e90 <argstr>
...
8010582d:	e8 ae f5 ff ff       	call   80104de0 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105842:	e8 99 f5 ff ff       	call   80104de0 <argint>
     argint(1, &major) < 0 ||
...
80105862:	e8 d9 f6 ff ff       	call   80104f40 <create>
     argint(2, &minor) < 0 ||
...
801058a9:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801058ac:	e8 af e0 ff ff       	call   80103960 <myproc>
...
801058c1:	e8 ca f5 ff ff       	call   80104e90 <argstr>
...
801058ed:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80105969:	e8 22 f5 ff ff       	call   80104e90 <argstr>
...
80105985:	e8 56 f4 ff ff       	call   80104de0 <argint>
...
801059aa:	e8 51 f1 ff ff       	call   80104b00 <memset>
...
801059cc:	e8 6f f3 ff ff       	call   80104d40 <fetchint>
...
801059f0:	e8 8b f3 ff ff       	call   80104d80 <fetchstr>
...
80105a65:	e8 c6 f3 ff ff       	call   80104e30 <argptr>
...
80105a8b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105a8d:	e8 ce de ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105b30:	f3 0f 1e fb          	endbr32 
  return fork();
80105b34:	e9 d7 df ff ff       	jmp    80103b10 <fork>
...
80105b47:	83 ec 08             	sub    $0x8,%esp
  exit();
80105b4a:	e8 41 e2 ff ff       	call   80103d90 <exit>
...
80105b60:	f3 0f 1e fb          	endbr32 
  return wait();
80105b64:	e9 77 e4 ff ff       	jmp    80103fe0 <wait>
...
80105b80:	e8 5b f2 ff ff       	call   80104de0 <argint>
...
80105b92:	e8 a9 e5 ff ff       	call   80104140 <kill>
...
80105bb7:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105bba:	e8 a1 dd ff ff       	call   80103960 <myproc>
...
80105bfa:	e8 91 de ff ff       	call   80103a90 <growproc>
...
80105c31:	e8 aa f1 ff ff       	call   80104de0 <argint>
...
80105c44:	68 80 65 11 80       	push   $0x80116580
80105c49:	e8 62 ed ff ff       	call   801049b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105c4e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105c51:	8b 1d c0 6d 11 80    	mov    0x80116dc0,%ebx
  while(ticks - ticks0 < n){
...
80105c63:	68 80 65 11 80       	push   $0x80116580
80105c68:	68 c0 6d 11 80       	push   $0x80116dc0
80105c6d:	e8 ae e2 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105c72:	a1 c0 6d 11 80       	mov    0x80116dc0,%eax
...
80105c7f:	73 2f                	jae    80105cb0 <sys_sleep+0x90>
    if(myproc()->killed){
80105c81:	e8 da dc ff ff       	call   80103960 <myproc>
...
80105c90:	68 80 65 11 80       	push   $0x80116580
...
80105cb3:	68 80 65 11 80       	push   $0x80116580
...
80105cd8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105cdb:	68 80 65 11 80       	push   $0x80116580
80105ce0:	e8 cb ec ff ff       	call   801049b0 <acquire>
  xticks = ticks;
80105ce5:	8b 1d c0 6d 11 80    	mov    0x80116dc0,%ebx
  release(&tickslock);
80105ceb:	c7 04 24 80 65 11 80 	movl   $0x80116580,(%esp)
...
80105d10:	e8 cb f0 ff ff       	call   80104de0 <argint>
  argint(1,&j);
80105d15:	58                   	pop    %eax
...
80105d1d:	e8 be f0 ff ff       	call   80104de0 <argint>
  return sem_init(i,j);
80105d22:	59                   	pop    %ecx
80105d23:	58                   	pop    %eax
80105d24:	ff 75 f4             	pushl  -0xc(%ebp)
80105d27:	ff 75 f0             	pushl  -0x10(%ebp)
80105d2a:	e8 11 e6 ff ff       	call   80104340 <sem_init>
}
80105d2f:	c9                   	leave  
80105d30:	c3                   	ret    
...
80105d50:	e8 8b f0 ff ff       	call   80104de0 <argint>
  return sem_acquire(i);
80105d55:	58                   	pop    %eax
80105d56:	ff 75 f4             	pushl  -0xc(%ebp)
80105d59:	e8 22 e6 ff ff       	call   80104380 <sem_acquire>
}
80105d5e:	c9                   	leave  
80105d5f:	c3                   	ret    

80105d60 <sys_sem_release>:
...
80105d70:	e8 6b f0 ff ff       	call   80104de0 <argint>
  return sem_release(i);
80105d75:	58                   	pop    %eax
80105d76:	ff 75 f4             	pushl  -0xc(%ebp)
80105d79:	e8 c2 e6 ff ff       	call   80104440 <sem_release>
}
80105d7e:	c9                   	leave  
80105d7f:	c3                   	ret    

80105d80 <sys_mutex_init>:
...
80105d90:	e8 4b f0 ff ff       	call   80104de0 <argint>
  return mutex_init(i);
80105d95:	58                   	pop    %eax
80105d96:	ff 75 f4             	pushl  -0xc(%ebp)
80105d99:	e8 62 e7 ff ff       	call   80104500 <mutex_init>
}
80105d9e:	c9                   	leave  
80105d9f:	c3                   	ret    

80105da0 <sys_mutex_acquire>:
...
80105db0:	e8 2b f0 ff ff       	call   80104de0 <argint>
  return mutex_acquire(i);
80105db5:	58                   	pop    %eax
80105db6:	ff 75 f4             	pushl  -0xc(%ebp)
80105db9:	e8 82 e7 ff ff       	call   80104540 <mutex_acquire>
}
80105dbe:	c9                   	leave  
80105dbf:	c3                   	ret    

80105dc0 <sys_mutex_release>:
...
80105dd0:	e8 0b f0 ff ff       	call   80104de0 <argint>
  return mutex_release(i);
80105dd5:	58                   	pop    %eax
80105dd6:	ff 75 f4             	pushl  -0xc(%ebp)
80105dd9:	e8 62 e8 ff ff       	call   80104640 <mutex_release>
80105dde:	c9                   	leave  
80105ddf:	c3                   	ret    
...
80105de1:	06                   	push   %es
  pushl %fs
80105de2:	0f a0                	push   %fs
  pushl %gs
80105de4:	0f a8                	push   %gs
  pushal
80105de6:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105de7:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105deb:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105ded:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105def:	54                   	push   %esp
  call trap
80105df0:	e8 cb 00 00 00       	call   80105ec0 <trap>
  addl $4, %esp
80105df5:	83 c4 04             	add    $0x4,%esp
...
80105df8:	61                   	popa   
  popl %gs
80105df9:	0f a9                	pop    %gs
  popl %fs
80105dfb:	0f a1                	pop    %fs
  popl %es
80105dfd:	07                   	pop    %es
  popl %ds
80105dfe:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105dff:	83 c4 08             	add    $0x8,%esp
  iret
80105e02:	cf                   	iret   
...
80105e27:	c7 04 c5 c2 65 11 80 	movl   $0x8e000008,-0x7fee9a3e(,%eax,8)
80105e2e:	08 00 00 8e 
80105e32:	66 89 14 c5 c0 65 11 	mov    %dx,-0x7fee9a40(,%eax,8)
80105e39:	80 
80105e3a:	c1 ea 10             	shr    $0x10,%edx
80105e3d:	66 89 14 c5 c6 65 11 	mov    %dx,-0x7fee9a3a(,%eax,8)
80105e44:	80 
  for(i = 0; i < 256; i++)
...
80105e57:	c7 05 c2 67 11 80 08 	movl   $0xef000008,0x801167c2
80105e5e:	00 00 ef 
  initlock(&tickslock, "time");
80105e61:	68 f1 7d 10 80       	push   $0x80107df1
80105e66:	68 80 65 11 80       	push   $0x80116580
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e6b:	66 a3 c0 67 11 80    	mov    %ax,0x801167c0
80105e71:	c1 e8 10             	shr    $0x10,%eax
80105e74:	66 a3 c6 67 11 80    	mov    %ax,0x801167c6
  initlock(&tickslock, "time");
80105e7a:	e8 a1 e9 ff ff       	call   80104820 <initlock>
}
...
80105e9f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ea3:	b8 c0 65 11 80       	mov    $0x801165c0,%eax
...
80105ed6:	0f 84 bc 01 00 00    	je     80106098 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105ee4:	3e ff 24 85 98 7e 10 	notrack jmp *-0x7fef8168(,%eax,4)
80105eeb:	80 
    lapiceoi();
    break;
...
80105eec:	e8 6f da ff ff       	call   80103960 <myproc>
80105ef1:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ef4:	85 c0                	test   %eax,%eax
80105ef6:	0f 84 eb 01 00 00    	je     801060e7 <trap+0x227>
80105efc:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105f00:	0f 84 e1 01 00 00    	je     801060e7 <trap+0x227>
...
80105f0c:	e8 2f da ff ff       	call   80103940 <cpuid>
...
80105f25:	e8 36 da ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105f41:	68 54 7e 10 80       	push   $0x80107e54
...
80105f5a:	e8 01 da ff ff       	call   80103960 <myproc>
80105f5f:	85 c0                	test   %eax,%eax
80105f61:	74 1d                	je     80105f80 <trap+0xc0>
80105f63:	e8 f8 d9 ff ff       	call   80103960 <myproc>
...
80105f7a:	0f 84 50 01 00 00    	je     801060d0 <trap+0x210>
    exit();
...
80105f87:	74 0f                	je     80105f98 <trap+0xd8>
80105f89:	e8 d2 d9 ff ff       	call   80103960 <myproc>
80105f8e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105f92:	0f 84 e8 00 00 00    	je     80106080 <trap+0x1c0>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f98:	e8 c3 d9 ff ff       	call   80103960 <myproc>
80105f9d:	85 c0                	test   %eax,%eax
80105f9f:	74 1d                	je     80105fbe <trap+0xfe>
80105fa1:	e8 ba d9 ff ff       	call   80103960 <myproc>
80105fa6:	8b 40 24             	mov    0x24(%eax),%eax
80105fa9:	85 c0                	test   %eax,%eax
80105fab:	74 11                	je     80105fbe <trap+0xfe>
80105fad:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105fb1:	83 e0 03             	and    $0x3,%eax
80105fb4:	66 83 f8 03          	cmp    $0x3,%ax
80105fb8:	0f 84 03 01 00 00    	je     801060c1 <trap+0x201>
    exit();
}
...
80105fc5:	c3                   	ret    
    ideintr();
80105fc6:	e8 15 c2 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105fcb:	e8 f0 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fd0:	e8 8b d9 ff ff       	call   80103960 <myproc>
80105fd5:	85 c0                	test   %eax,%eax
80105fd7:	75 8a                	jne    80105f63 <trap+0xa3>
80105fd9:	eb a5                	jmp    80105f80 <trap+0xc0>
    if(cpuid() == 0){
80105fdb:	e8 60 d9 ff ff       	call   80103940 <cpuid>
80105fe0:	85 c0                	test   %eax,%eax
80105fe2:	75 e7                	jne    80105fcb <trap+0x10b>
      acquire(&tickslock);
80105fe4:	83 ec 0c             	sub    $0xc,%esp
80105fe7:	68 80 65 11 80       	push   $0x80116580
80105fec:	e8 bf e9 ff ff       	call   801049b0 <acquire>
      wakeup(&ticks);
80105ff1:	c7 04 24 c0 6d 11 80 	movl   $0x80116dc0,(%esp)
      ticks++;
80105ff8:	83 05 c0 6d 11 80 01 	addl   $0x1,0x80116dc0
      wakeup(&ticks);
80105fff:	e8 dc e0 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80106004:	c7 04 24 80 65 11 80 	movl   $0x80116580,(%esp)
8010600b:	e8 90 ea ff ff       	call   80104aa0 <release>
80106010:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106013:	eb b6                	jmp    80105fcb <trap+0x10b>
    kbdintr();
80106015:	e8 66 c7 ff ff       	call   80102780 <kbdintr>
    lapiceoi();
8010601a:	e8 a1 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010601f:	e8 3c d9 ff ff       	call   80103960 <myproc>
80106024:	85 c0                	test   %eax,%eax
80106026:	0f 85 37 ff ff ff    	jne    80105f63 <trap+0xa3>
8010602c:	e9 4f ff ff ff       	jmp    80105f80 <trap+0xc0>
    uartintr();
80106031:	e8 4a 02 00 00       	call   80106280 <uartintr>
    lapiceoi();
80106036:	e8 85 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010603b:	e8 20 d9 ff ff       	call   80103960 <myproc>
80106040:	85 c0                	test   %eax,%eax
80106042:	0f 85 1b ff ff ff    	jne    80105f63 <trap+0xa3>
80106048:	e9 33 ff ff ff       	jmp    80105f80 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010604d:	8b 7b 38             	mov    0x38(%ebx),%edi
80106050:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106054:	e8 e7 d8 ff ff       	call   80103940 <cpuid>
80106059:	57                   	push   %edi
8010605a:	56                   	push   %esi
8010605b:	50                   	push   %eax
8010605c:	68 fc 7d 10 80       	push   $0x80107dfc
80106061:	e8 4a a6 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80106066:	e8 55 c8 ff ff       	call   801028c0 <lapiceoi>
    break;
8010606b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010606e:	e8 ed d8 ff ff       	call   80103960 <myproc>
80106073:	85 c0                	test   %eax,%eax
80106075:	0f 85 e8 fe ff ff    	jne    80105f63 <trap+0xa3>
8010607b:	e9 00 ff ff ff       	jmp    80105f80 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80106080:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80106084:	0f 85 0e ff ff ff    	jne    80105f98 <trap+0xd8>
    yield();
8010608a:	e8 41 de ff ff       	call   80103ed0 <yield>
8010608f:	e9 04 ff ff ff       	jmp    80105f98 <trap+0xd8>
80106094:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80106098:	e8 c3 d8 ff ff       	call   80103960 <myproc>
8010609d:	8b 70 24             	mov    0x24(%eax),%esi
801060a0:	85 f6                	test   %esi,%esi
801060a2:	75 3c                	jne    801060e0 <trap+0x220>
    myproc()->tf = tf;
801060a4:	e8 b7 d8 ff ff       	call   80103960 <myproc>
801060a9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801060ac:	e8 1f ee ff ff       	call   80104ed0 <syscall>
    if(myproc()->killed)
801060b1:	e8 aa d8 ff ff       	call   80103960 <myproc>
801060b6:	8b 48 24             	mov    0x24(%eax),%ecx
801060b9:	85 c9                	test   %ecx,%ecx
801060bb:	0f 84 fd fe ff ff    	je     80105fbe <trap+0xfe>
}
...
801060c7:	5d                   	pop    %ebp
      exit();
801060c8:	e9 c3 dc ff ff       	jmp    80103d90 <exit>
801060cd:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
801060d0:	e8 bb dc ff ff       	call   80103d90 <exit>
801060d5:	e9 a6 fe ff ff       	jmp    80105f80 <trap+0xc0>
801060da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801060e0:	e8 ab dc ff ff       	call   80103d90 <exit>
801060e5:	eb bd                	jmp    801060a4 <trap+0x1e4>
801060e7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801060ea:	e8 51 d8 ff ff       	call   80103940 <cpuid>
801060ef:	83 ec 0c             	sub    $0xc,%esp
801060f2:	56                   	push   %esi
801060f3:	57                   	push   %edi
801060f4:	50                   	push   %eax
801060f5:	ff 73 30             	pushl  0x30(%ebx)
801060f8:	68 20 7e 10 80       	push   $0x80107e20
801060fd:	e8 ae a5 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80106102:	83 c4 14             	add    $0x14,%esp
80106105:	68 f6 7d 10 80       	push   $0x80107df6
8010610a:	e8 81 a2 ff ff       	call   80100390 <panic>
8010610f:	90                   	nop
...
80106110:	f3 0f 1e fb          	endbr32 
  if(!uart)
80106114:	a1 c0 b5 10 80       	mov    0x8010b5c0,%eax
...
80106165:	e8 76 c7 ff ff       	call   801028e0 <microdelay>
...
801061eb:	74 52                	je     8010623f <uartinit+0xaf>
  uart = 1;
801061ed:	c7 05 c0 b5 10 80 01 	movl   $0x1,0x8010b5c0
801061f4:	00 00 00 
...
80106203:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106208:	bb 18 7f 10 80       	mov    $0x80107f18,%ebx
  ioapicenable(IRQ_COM1, 0);
8010620d:	6a 00                	push   $0x0
8010620f:	6a 04                	push   $0x4
80106211:	e8 1a c2 ff ff       	call   80102430 <ioapicenable>
...
80106220:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80106224:	8b 15 c0 b5 10 80    	mov    0x8010b5c0,%edx
...
80106254:	55                   	push   %ebp
  if(!uart)
80106255:	8b 15 c0 b5 10 80    	mov    0x8010b5c0,%edx
{
...
8010629b:	6a 00                	push   $0x0
  jmp alltraps
8010629d:	e9 3e fb ff ff       	jmp    80105de0 <alltraps>
...
801062a4:	6a 01                	push   $0x1
  jmp alltraps
801062a6:	e9 35 fb ff ff       	jmp    80105de0 <alltraps>
...
801062ad:	6a 02                	push   $0x2
  jmp alltraps
801062af:	e9 2c fb ff ff       	jmp    80105de0 <alltraps>
...
801062b6:	6a 03                	push   $0x3
  jmp alltraps
801062b8:	e9 23 fb ff ff       	jmp    80105de0 <alltraps>
...
801062bf:	6a 04                	push   $0x4
  jmp alltraps
801062c1:	e9 1a fb ff ff       	jmp    80105de0 <alltraps>
...
801062c8:	6a 05                	push   $0x5
  jmp alltraps
801062ca:	e9 11 fb ff ff       	jmp    80105de0 <alltraps>
...
801062d1:	6a 06                	push   $0x6
  jmp alltraps
801062d3:	e9 08 fb ff ff       	jmp    80105de0 <alltraps>
...
801062da:	6a 07                	push   $0x7
  jmp alltraps
801062dc:	e9 ff fa ff ff       	jmp    80105de0 <alltraps>
...
801062e1:	6a 08                	push   $0x8
  jmp alltraps
801062e3:	e9 f8 fa ff ff       	jmp    80105de0 <alltraps>
...
801062ea:	6a 09                	push   $0x9
  jmp alltraps
801062ec:	e9 ef fa ff ff       	jmp    80105de0 <alltraps>
...
801062f1:	6a 0a                	push   $0xa
  jmp alltraps
801062f3:	e9 e8 fa ff ff       	jmp    80105de0 <alltraps>
...
801062f8:	6a 0b                	push   $0xb
  jmp alltraps
801062fa:	e9 e1 fa ff ff       	jmp    80105de0 <alltraps>
...
801062ff:	6a 0c                	push   $0xc
  jmp alltraps
80106301:	e9 da fa ff ff       	jmp    80105de0 <alltraps>
...
80106306:	6a 0d                	push   $0xd
  jmp alltraps
80106308:	e9 d3 fa ff ff       	jmp    80105de0 <alltraps>
...
8010630d:	6a 0e                	push   $0xe
  jmp alltraps
8010630f:	e9 cc fa ff ff       	jmp    80105de0 <alltraps>
...
80106316:	6a 0f                	push   $0xf
  jmp alltraps
80106318:	e9 c3 fa ff ff       	jmp    80105de0 <alltraps>
...
8010631f:	6a 10                	push   $0x10
  jmp alltraps
80106321:	e9 ba fa ff ff       	jmp    80105de0 <alltraps>
...
80106326:	6a 11                	push   $0x11
  jmp alltraps
80106328:	e9 b3 fa ff ff       	jmp    80105de0 <alltraps>
...
8010632f:	6a 12                	push   $0x12
  jmp alltraps
80106331:	e9 aa fa ff ff       	jmp    80105de0 <alltraps>
...
80106338:	6a 13                	push   $0x13
  jmp alltraps
8010633a:	e9 a1 fa ff ff       	jmp    80105de0 <alltraps>
...
80106341:	6a 14                	push   $0x14
  jmp alltraps
80106343:	e9 98 fa ff ff       	jmp    80105de0 <alltraps>
...
8010634a:	6a 15                	push   $0x15
  jmp alltraps
8010634c:	e9 8f fa ff ff       	jmp    80105de0 <alltraps>
...
80106353:	6a 16                	push   $0x16
  jmp alltraps
80106355:	e9 86 fa ff ff       	jmp    80105de0 <alltraps>
...
8010635c:	6a 17                	push   $0x17
  jmp alltraps
8010635e:	e9 7d fa ff ff       	jmp    80105de0 <alltraps>
...
80106365:	6a 18                	push   $0x18
  jmp alltraps
80106367:	e9 74 fa ff ff       	jmp    80105de0 <alltraps>
...
8010636e:	6a 19                	push   $0x19
  jmp alltraps
80106370:	e9 6b fa ff ff       	jmp    80105de0 <alltraps>
...
80106377:	6a 1a                	push   $0x1a
  jmp alltraps
80106379:	e9 62 fa ff ff       	jmp    80105de0 <alltraps>
...
80106380:	6a 1b                	push   $0x1b
  jmp alltraps
80106382:	e9 59 fa ff ff       	jmp    80105de0 <alltraps>
...
80106389:	6a 1c                	push   $0x1c
  jmp alltraps
8010638b:	e9 50 fa ff ff       	jmp    80105de0 <alltraps>
...
80106392:	6a 1d                	push   $0x1d
  jmp alltraps
80106394:	e9 47 fa ff ff       	jmp    80105de0 <alltraps>
...
8010639b:	6a 1e                	push   $0x1e
  jmp alltraps
8010639d:	e9 3e fa ff ff       	jmp    80105de0 <alltraps>
...
801063a4:	6a 1f                	push   $0x1f
  jmp alltraps
801063a6:	e9 35 fa ff ff       	jmp    80105de0 <alltraps>
...
801063ad:	6a 20                	push   $0x20
  jmp alltraps
801063af:	e9 2c fa ff ff       	jmp    80105de0 <alltraps>
...
801063b6:	6a 21                	push   $0x21
  jmp alltraps
801063b8:	e9 23 fa ff ff       	jmp    80105de0 <alltraps>
...
801063bf:	6a 22                	push   $0x22
  jmp alltraps
801063c1:	e9 1a fa ff ff       	jmp    80105de0 <alltraps>
...
801063c8:	6a 23                	push   $0x23
  jmp alltraps
801063ca:	e9 11 fa ff ff       	jmp    80105de0 <alltraps>
...
801063d1:	6a 24                	push   $0x24
  jmp alltraps
801063d3:	e9 08 fa ff ff       	jmp    80105de0 <alltraps>
...
801063da:	6a 25                	push   $0x25
  jmp alltraps
801063dc:	e9 ff f9 ff ff       	jmp    80105de0 <alltraps>
...
801063e3:	6a 26                	push   $0x26
  jmp alltraps
801063e5:	e9 f6 f9 ff ff       	jmp    80105de0 <alltraps>
...
801063ec:	6a 27                	push   $0x27
  jmp alltraps
801063ee:	e9 ed f9 ff ff       	jmp    80105de0 <alltraps>
...
801063f5:	6a 28                	push   $0x28
  jmp alltraps
801063f7:	e9 e4 f9 ff ff       	jmp    80105de0 <alltraps>
...
801063fe:	6a 29                	push   $0x29
  jmp alltraps
80106400:	e9 db f9 ff ff       	jmp    80105de0 <alltraps>
...
80106407:	6a 2a                	push   $0x2a
  jmp alltraps
80106409:	e9 d2 f9 ff ff       	jmp    80105de0 <alltraps>
...
80106410:	6a 2b                	push   $0x2b
  jmp alltraps
80106412:	e9 c9 f9 ff ff       	jmp    80105de0 <alltraps>
...
80106419:	6a 2c                	push   $0x2c
  jmp alltraps
8010641b:	e9 c0 f9 ff ff       	jmp    80105de0 <alltraps>
...
80106422:	6a 2d                	push   $0x2d
  jmp alltraps
80106424:	e9 b7 f9 ff ff       	jmp    80105de0 <alltraps>
...
8010642b:	6a 2e                	push   $0x2e
  jmp alltraps
8010642d:	e9 ae f9 ff ff       	jmp    80105de0 <alltraps>
...
80106434:	6a 2f                	push   $0x2f
  jmp alltraps
80106436:	e9 a5 f9 ff ff       	jmp    80105de0 <alltraps>
...
8010643d:	6a 30                	push   $0x30
  jmp alltraps
8010643f:	e9 9c f9 ff ff       	jmp    80105de0 <alltraps>
...
80106446:	6a 31                	push   $0x31
  jmp alltraps
80106448:	e9 93 f9 ff ff       	jmp    80105de0 <alltraps>
...
8010644f:	6a 32                	push   $0x32
  jmp alltraps
80106451:	e9 8a f9 ff ff       	jmp    80105de0 <alltraps>
...
80106458:	6a 33                	push   $0x33
  jmp alltraps
8010645a:	e9 81 f9 ff ff       	jmp    80105de0 <alltraps>
...
80106461:	6a 34                	push   $0x34
  jmp alltraps
80106463:	e9 78 f9 ff ff       	jmp    80105de0 <alltraps>
...
8010646a:	6a 35                	push   $0x35
  jmp alltraps
8010646c:	e9 6f f9 ff ff       	jmp    80105de0 <alltraps>
...
80106473:	6a 36                	push   $0x36
  jmp alltraps
80106475:	e9 66 f9 ff ff       	jmp    80105de0 <alltraps>
...
8010647c:	6a 37                	push   $0x37
  jmp alltraps
8010647e:	e9 5d f9 ff ff       	jmp    80105de0 <alltraps>
...
80106485:	6a 38                	push   $0x38
  jmp alltraps
80106487:	e9 54 f9 ff ff       	jmp    80105de0 <alltraps>
...
8010648e:	6a 39                	push   $0x39
  jmp alltraps
80106490:	e9 4b f9 ff ff       	jmp    80105de0 <alltraps>
...
80106497:	6a 3a                	push   $0x3a
  jmp alltraps
80106499:	e9 42 f9 ff ff       	jmp    80105de0 <alltraps>
...
801064a0:	6a 3b                	push   $0x3b
  jmp alltraps
801064a2:	e9 39 f9 ff ff       	jmp    80105de0 <alltraps>
...
801064a9:	6a 3c                	push   $0x3c
  jmp alltraps
801064ab:	e9 30 f9 ff ff       	jmp    80105de0 <alltraps>
...
801064b2:	6a 3d                	push   $0x3d
  jmp alltraps
801064b4:	e9 27 f9 ff ff       	jmp    80105de0 <alltraps>
...
801064bb:	6a 3e                	push   $0x3e
  jmp alltraps
801064bd:	e9 1e f9 ff ff       	jmp    80105de0 <alltraps>
...
801064c4:	6a 3f                	push   $0x3f
  jmp alltraps
801064c6:	e9 15 f9 ff ff       	jmp    80105de0 <alltraps>
...
801064cd:	6a 40                	push   $0x40
  jmp alltraps
801064cf:	e9 0c f9 ff ff       	jmp    80105de0 <alltraps>
...
801064d6:	6a 41                	push   $0x41
  jmp alltraps
801064d8:	e9 03 f9 ff ff       	jmp    80105de0 <alltraps>
...
801064df:	6a 42                	push   $0x42
  jmp alltraps
801064e1:	e9 fa f8 ff ff       	jmp    80105de0 <alltraps>
...
801064e8:	6a 43                	push   $0x43
  jmp alltraps
801064ea:	e9 f1 f8 ff ff       	jmp    80105de0 <alltraps>
...
801064f1:	6a 44                	push   $0x44
  jmp alltraps
801064f3:	e9 e8 f8 ff ff       	jmp    80105de0 <alltraps>
...
801064fa:	6a 45                	push   $0x45
  jmp alltraps
801064fc:	e9 df f8 ff ff       	jmp    80105de0 <alltraps>
...
80106503:	6a 46                	push   $0x46
  jmp alltraps
80106505:	e9 d6 f8 ff ff       	jmp    80105de0 <alltraps>
...
8010650c:	6a 47                	push   $0x47
  jmp alltraps
8010650e:	e9 cd f8 ff ff       	jmp    80105de0 <alltraps>
...
80106515:	6a 48                	push   $0x48
  jmp alltraps
80106517:	e9 c4 f8 ff ff       	jmp    80105de0 <alltraps>
...
8010651e:	6a 49                	push   $0x49
  jmp alltraps
80106520:	e9 bb f8 ff ff       	jmp    80105de0 <alltraps>
...
80106527:	6a 4a                	push   $0x4a
  jmp alltraps
80106529:	e9 b2 f8 ff ff       	jmp    80105de0 <alltraps>
...
80106530:	6a 4b                	push   $0x4b
  jmp alltraps
80106532:	e9 a9 f8 ff ff       	jmp    80105de0 <alltraps>
...
80106539:	6a 4c                	push   $0x4c
  jmp alltraps
8010653b:	e9 a0 f8 ff ff       	jmp    80105de0 <alltraps>
...
80106542:	6a 4d                	push   $0x4d
  jmp alltraps
80106544:	e9 97 f8 ff ff       	jmp    80105de0 <alltraps>
...
8010654b:	6a 4e                	push   $0x4e
  jmp alltraps
8010654d:	e9 8e f8 ff ff       	jmp    80105de0 <alltraps>
...
80106554:	6a 4f                	push   $0x4f
  jmp alltraps
80106556:	e9 85 f8 ff ff       	jmp    80105de0 <alltraps>
...
8010655d:	6a 50                	push   $0x50
  jmp alltraps
8010655f:	e9 7c f8 ff ff       	jmp    80105de0 <alltraps>
...
80106566:	6a 51                	push   $0x51
  jmp alltraps
80106568:	e9 73 f8 ff ff       	jmp    80105de0 <alltraps>
...
8010656f:	6a 52                	push   $0x52
  jmp alltraps
80106571:	e9 6a f8 ff ff       	jmp    80105de0 <alltraps>
...
80106578:	6a 53                	push   $0x53
  jmp alltraps
8010657a:	e9 61 f8 ff ff       	jmp    80105de0 <alltraps>
...
80106581:	6a 54                	push   $0x54
  jmp alltraps
80106583:	e9 58 f8 ff ff       	jmp    80105de0 <alltraps>
...
8010658a:	6a 55                	push   $0x55
  jmp alltraps
8010658c:	e9 4f f8 ff ff       	jmp    80105de0 <alltraps>
...
80106593:	6a 56                	push   $0x56
  jmp alltraps
80106595:	e9 46 f8 ff ff       	jmp    80105de0 <alltraps>
...
8010659c:	6a 57                	push   $0x57
  jmp alltraps
8010659e:	e9 3d f8 ff ff       	jmp    80105de0 <alltraps>
...
801065a5:	6a 58                	push   $0x58
  jmp alltraps
801065a7:	e9 34 f8 ff ff       	jmp    80105de0 <alltraps>
...
801065ae:	6a 59                	push   $0x59
  jmp alltraps
801065b0:	e9 2b f8 ff ff       	jmp    80105de0 <alltraps>
...
801065b7:	6a 5a                	push   $0x5a
  jmp alltraps
801065b9:	e9 22 f8 ff ff       	jmp    80105de0 <alltraps>
...
801065c0:	6a 5b                	push   $0x5b
  jmp alltraps
801065c2:	e9 19 f8 ff ff       	jmp    80105de0 <alltraps>
...
801065c9:	6a 5c                	push   $0x5c
  jmp alltraps
801065cb:	e9 10 f8 ff ff       	jmp    80105de0 <alltraps>
...
801065d2:	6a 5d                	push   $0x5d
  jmp alltraps
801065d4:	e9 07 f8 ff ff       	jmp    80105de0 <alltraps>
...
801065db:	6a 5e                	push   $0x5e
  jmp alltraps
801065dd:	e9 fe f7 ff ff       	jmp    80105de0 <alltraps>
...
801065e4:	6a 5f                	push   $0x5f
  jmp alltraps
801065e6:	e9 f5 f7 ff ff       	jmp    80105de0 <alltraps>
...
801065ed:	6a 60                	push   $0x60
  jmp alltraps
801065ef:	e9 ec f7 ff ff       	jmp    80105de0 <alltraps>
...
801065f6:	6a 61                	push   $0x61
  jmp alltraps
801065f8:	e9 e3 f7 ff ff       	jmp    80105de0 <alltraps>
...
801065ff:	6a 62                	push   $0x62
  jmp alltraps
80106601:	e9 da f7 ff ff       	jmp    80105de0 <alltraps>
...
80106608:	6a 63                	push   $0x63
  jmp alltraps
8010660a:	e9 d1 f7 ff ff       	jmp    80105de0 <alltraps>
...
80106611:	6a 64                	push   $0x64
  jmp alltraps
80106613:	e9 c8 f7 ff ff       	jmp    80105de0 <alltraps>
...
8010661a:	6a 65                	push   $0x65
  jmp alltraps
8010661c:	e9 bf f7 ff ff       	jmp    80105de0 <alltraps>
...
80106623:	6a 66                	push   $0x66
  jmp alltraps
80106625:	e9 b6 f7 ff ff       	jmp    80105de0 <alltraps>
...
8010662c:	6a 67                	push   $0x67
  jmp alltraps
8010662e:	e9 ad f7 ff ff       	jmp    80105de0 <alltraps>
...
80106635:	6a 68                	push   $0x68
  jmp alltraps
80106637:	e9 a4 f7 ff ff       	jmp    80105de0 <alltraps>
...
8010663e:	6a 69                	push   $0x69
  jmp alltraps
80106640:	e9 9b f7 ff ff       	jmp    80105de0 <alltraps>
...
80106647:	6a 6a                	push   $0x6a
  jmp alltraps
80106649:	e9 92 f7 ff ff       	jmp    80105de0 <alltraps>
...
80106650:	6a 6b                	push   $0x6b
  jmp alltraps
80106652:	e9 89 f7 ff ff       	jmp    80105de0 <alltraps>
...
80106659:	6a 6c                	push   $0x6c
  jmp alltraps
8010665b:	e9 80 f7 ff ff       	jmp    80105de0 <alltraps>
...
80106662:	6a 6d                	push   $0x6d
  jmp alltraps
80106664:	e9 77 f7 ff ff       	jmp    80105de0 <alltraps>
...
8010666b:	6a 6e                	push   $0x6e
  jmp alltraps
8010666d:	e9 6e f7 ff ff       	jmp    80105de0 <alltraps>
...
80106674:	6a 6f                	push   $0x6f
  jmp alltraps
80106676:	e9 65 f7 ff ff       	jmp    80105de0 <alltraps>
...
8010667d:	6a 70                	push   $0x70
  jmp alltraps
8010667f:	e9 5c f7 ff ff       	jmp    80105de0 <alltraps>
...
80106686:	6a 71                	push   $0x71
  jmp alltraps
80106688:	e9 53 f7 ff ff       	jmp    80105de0 <alltraps>
...
8010668f:	6a 72                	push   $0x72
  jmp alltraps
80106691:	e9 4a f7 ff ff       	jmp    80105de0 <alltraps>
...
80106698:	6a 73                	push   $0x73
  jmp alltraps
8010669a:	e9 41 f7 ff ff       	jmp    80105de0 <alltraps>
...
801066a1:	6a 74                	push   $0x74
  jmp alltraps
801066a3:	e9 38 f7 ff ff       	jmp    80105de0 <alltraps>
...
801066aa:	6a 75                	push   $0x75
  jmp alltraps
801066ac:	e9 2f f7 ff ff       	jmp    80105de0 <alltraps>
...
801066b3:	6a 76                	push   $0x76
  jmp alltraps
801066b5:	e9 26 f7 ff ff       	jmp    80105de0 <alltraps>
...
801066bc:	6a 77                	push   $0x77
  jmp alltraps
801066be:	e9 1d f7 ff ff       	jmp    80105de0 <alltraps>
...
801066c5:	6a 78                	push   $0x78
  jmp alltraps
801066c7:	e9 14 f7 ff ff       	jmp    80105de0 <alltraps>
...
801066ce:	6a 79                	push   $0x79
  jmp alltraps
801066d0:	e9 0b f7 ff ff       	jmp    80105de0 <alltraps>
...
801066d7:	6a 7a                	push   $0x7a
  jmp alltraps
801066d9:	e9 02 f7 ff ff       	jmp    80105de0 <alltraps>
...
801066e0:	6a 7b                	push   $0x7b
  jmp alltraps
801066e2:	e9 f9 f6 ff ff       	jmp    80105de0 <alltraps>
...
801066e9:	6a 7c                	push   $0x7c
  jmp alltraps
801066eb:	e9 f0 f6 ff ff       	jmp    80105de0 <alltraps>
...
801066f2:	6a 7d                	push   $0x7d
  jmp alltraps
801066f4:	e9 e7 f6 ff ff       	jmp    80105de0 <alltraps>
...
801066fb:	6a 7e                	push   $0x7e
  jmp alltraps
801066fd:	e9 de f6 ff ff       	jmp    80105de0 <alltraps>
...
80106704:	6a 7f                	push   $0x7f
  jmp alltraps
80106706:	e9 d5 f6 ff ff       	jmp    80105de0 <alltraps>
...
8010670d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106712:	e9 c9 f6 ff ff       	jmp    80105de0 <alltraps>
...
80106719:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010671e:	e9 bd f6 ff ff       	jmp    80105de0 <alltraps>
...
80106725:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010672a:	e9 b1 f6 ff ff       	jmp    80105de0 <alltraps>
...
80106731:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106736:	e9 a5 f6 ff ff       	jmp    80105de0 <alltraps>
...
8010673d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106742:	e9 99 f6 ff ff       	jmp    80105de0 <alltraps>
...
80106749:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010674e:	e9 8d f6 ff ff       	jmp    80105de0 <alltraps>
...
80106755:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010675a:	e9 81 f6 ff ff       	jmp    80105de0 <alltraps>
...
80106761:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106766:	e9 75 f6 ff ff       	jmp    80105de0 <alltraps>
...
8010676d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106772:	e9 69 f6 ff ff       	jmp    80105de0 <alltraps>
...
80106779:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010677e:	e9 5d f6 ff ff       	jmp    80105de0 <alltraps>
...
80106785:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010678a:	e9 51 f6 ff ff       	jmp    80105de0 <alltraps>
...
80106791:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106796:	e9 45 f6 ff ff       	jmp    80105de0 <alltraps>
...
8010679d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801067a2:	e9 39 f6 ff ff       	jmp    80105de0 <alltraps>
...
801067a9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801067ae:	e9 2d f6 ff ff       	jmp    80105de0 <alltraps>
...
801067b5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801067ba:	e9 21 f6 ff ff       	jmp    80105de0 <alltraps>
...
801067c1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801067c6:	e9 15 f6 ff ff       	jmp    80105de0 <alltraps>
...
801067cd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801067d2:	e9 09 f6 ff ff       	jmp    80105de0 <alltraps>
...
801067d9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801067de:	e9 fd f5 ff ff       	jmp    80105de0 <alltraps>
...
801067e5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801067ea:	e9 f1 f5 ff ff       	jmp    80105de0 <alltraps>
...
801067f1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801067f6:	e9 e5 f5 ff ff       	jmp    80105de0 <alltraps>
...
801067fd:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106802:	e9 d9 f5 ff ff       	jmp    80105de0 <alltraps>
...
80106809:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010680e:	e9 cd f5 ff ff       	jmp    80105de0 <alltraps>
...
80106815:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010681a:	e9 c1 f5 ff ff       	jmp    80105de0 <alltraps>
...
80106821:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106826:	e9 b5 f5 ff ff       	jmp    80105de0 <alltraps>
...
8010682d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106832:	e9 a9 f5 ff ff       	jmp    80105de0 <alltraps>
...
80106839:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010683e:	e9 9d f5 ff ff       	jmp    80105de0 <alltraps>
...
80106845:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010684a:	e9 91 f5 ff ff       	jmp    80105de0 <alltraps>
...
80106851:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106856:	e9 85 f5 ff ff       	jmp    80105de0 <alltraps>
...
8010685d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106862:	e9 79 f5 ff ff       	jmp    80105de0 <alltraps>
...
80106869:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010686e:	e9 6d f5 ff ff       	jmp    80105de0 <alltraps>
...
80106875:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010687a:	e9 61 f5 ff ff       	jmp    80105de0 <alltraps>
...
80106881:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106886:	e9 55 f5 ff ff       	jmp    80105de0 <alltraps>
...
8010688d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106892:	e9 49 f5 ff ff       	jmp    80105de0 <alltraps>
...
80106899:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010689e:	e9 3d f5 ff ff       	jmp    80105de0 <alltraps>
...
801068a5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801068aa:	e9 31 f5 ff ff       	jmp    80105de0 <alltraps>
...
801068b1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801068b6:	e9 25 f5 ff ff       	jmp    80105de0 <alltraps>
...
801068bd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801068c2:	e9 19 f5 ff ff       	jmp    80105de0 <alltraps>
...
801068c9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801068ce:	e9 0d f5 ff ff       	jmp    80105de0 <alltraps>
...
801068d5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801068da:	e9 01 f5 ff ff       	jmp    80105de0 <alltraps>
...
801068e1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801068e6:	e9 f5 f4 ff ff       	jmp    80105de0 <alltraps>
...
801068ed:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801068f2:	e9 e9 f4 ff ff       	jmp    80105de0 <alltraps>
...
801068f9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801068fe:	e9 dd f4 ff ff       	jmp    80105de0 <alltraps>
...
80106905:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010690a:	e9 d1 f4 ff ff       	jmp    80105de0 <alltraps>
...
80106911:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106916:	e9 c5 f4 ff ff       	jmp    80105de0 <alltraps>
...
8010691d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106922:	e9 b9 f4 ff ff       	jmp    80105de0 <alltraps>
...
80106929:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010692e:	e9 ad f4 ff ff       	jmp    80105de0 <alltraps>
...
80106935:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010693a:	e9 a1 f4 ff ff       	jmp    80105de0 <alltraps>
...
80106941:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106946:	e9 95 f4 ff ff       	jmp    80105de0 <alltraps>
...
8010694d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106952:	e9 89 f4 ff ff       	jmp    80105de0 <alltraps>
...
80106959:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010695e:	e9 7d f4 ff ff       	jmp    80105de0 <alltraps>
...
80106965:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010696a:	e9 71 f4 ff ff       	jmp    80105de0 <alltraps>
...
80106971:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106976:	e9 65 f4 ff ff       	jmp    80105de0 <alltraps>
...
8010697d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106982:	e9 59 f4 ff ff       	jmp    80105de0 <alltraps>
...
80106989:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010698e:	e9 4d f4 ff ff       	jmp    80105de0 <alltraps>
...
80106995:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010699a:	e9 41 f4 ff ff       	jmp    80105de0 <alltraps>
...
801069a1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801069a6:	e9 35 f4 ff ff       	jmp    80105de0 <alltraps>
...
801069ad:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801069b2:	e9 29 f4 ff ff       	jmp    80105de0 <alltraps>
...
801069b9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801069be:	e9 1d f4 ff ff       	jmp    80105de0 <alltraps>
...
801069c5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801069ca:	e9 11 f4 ff ff       	jmp    80105de0 <alltraps>
...
801069d1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801069d6:	e9 05 f4 ff ff       	jmp    80105de0 <alltraps>
...
801069dd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801069e2:	e9 f9 f3 ff ff       	jmp    80105de0 <alltraps>
...
801069e9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801069ee:	e9 ed f3 ff ff       	jmp    80105de0 <alltraps>
...
801069f5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801069fa:	e9 e1 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a01:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106a06:	e9 d5 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a0d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106a12:	e9 c9 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a19:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106a1e:	e9 bd f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a25:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106a2a:	e9 b1 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a31:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106a36:	e9 a5 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a3d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106a42:	e9 99 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a49:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106a4e:	e9 8d f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a55:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106a5a:	e9 81 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a61:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106a66:	e9 75 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a6d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106a72:	e9 69 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a79:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106a7e:	e9 5d f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a85:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106a8a:	e9 51 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a91:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106a96:	e9 45 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106a9d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106aa2:	e9 39 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106aa9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106aae:	e9 2d f3 ff ff       	jmp    80105de0 <alltraps>
...
80106ab5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106aba:	e9 21 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106ac1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106ac6:	e9 15 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106acd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106ad2:	e9 09 f3 ff ff       	jmp    80105de0 <alltraps>
...
80106ad9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106ade:	e9 fd f2 ff ff       	jmp    80105de0 <alltraps>
...
80106ae5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106aea:	e9 f1 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106af1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106af6:	e9 e5 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106afd:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106b02:	e9 d9 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b09:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106b0e:	e9 cd f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b15:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106b1a:	e9 c1 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b21:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106b26:	e9 b5 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b2d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106b32:	e9 a9 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b39:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106b3e:	e9 9d f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b45:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106b4a:	e9 91 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b51:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106b56:	e9 85 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b5d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106b62:	e9 79 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b69:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106b6e:	e9 6d f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b75:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106b7a:	e9 61 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b81:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106b86:	e9 55 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b8d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106b92:	e9 49 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106b99:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106b9e:	e9 3d f2 ff ff       	jmp    80105de0 <alltraps>
...
80106ba5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106baa:	e9 31 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106bb1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106bb6:	e9 25 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106bbd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106bc2:	e9 19 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106bc9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106bce:	e9 0d f2 ff ff       	jmp    80105de0 <alltraps>
...
80106bd5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106bda:	e9 01 f2 ff ff       	jmp    80105de0 <alltraps>
...
80106be1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106be6:	e9 f5 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106bed:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106bf2:	e9 e9 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106bf9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106bfe:	e9 dd f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c05:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106c0a:	e9 d1 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c11:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106c16:	e9 c5 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c1d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106c22:	e9 b9 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c29:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106c2e:	e9 ad f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c35:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106c3a:	e9 a1 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c41:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106c46:	e9 95 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c4d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106c52:	e9 89 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c59:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106c5e:	e9 7d f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c65:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106c6a:	e9 71 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c71:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106c76:	e9 65 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c7d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106c82:	e9 59 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c89:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106c8e:	e9 4d f1 ff ff       	jmp    80105de0 <alltraps>
...
80106c95:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106c9a:	e9 41 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106ca1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106ca6:	e9 35 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106cad:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106cb2:	e9 29 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106cb9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106cbe:	e9 1d f1 ff ff       	jmp    80105de0 <alltraps>
...
80106cc5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106cca:	e9 11 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106cd1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106cd6:	e9 05 f1 ff ff       	jmp    80105de0 <alltraps>
...
80106cdd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106ce2:	e9 f9 f0 ff ff       	jmp    80105de0 <alltraps>
...
80106ce9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106cee:	e9 ed f0 ff ff       	jmp    80105de0 <alltraps>
...
80106cf5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106cfa:	e9 e1 f0 ff ff       	jmp    80105de0 <alltraps>
...
80106d01:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106d06:	e9 d5 f0 ff ff       	jmp    80105de0 <alltraps>
...
80106d54:	e8 d7 b8 ff ff       	call   80102630 <kalloc>
...
80106d6a:	e8 91 dd ff ff       	call   80104b00 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106e0d:	68 20 7f 10 80       	push   $0x80107f20
...
80106e88:	e8 e3 b5 ff ff       	call   80102470 <kfree>
      *pte = 0;
...
80106ec3:	68 c6 78 10 80       	push   $0x801078c6
...
80106ed7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106eda:	e8 61 ca ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106eee:	c7 80 98 39 11 80 ff 	movl   $0xffff,-0x7feec668(%eax)
80106ef5:	ff 00 00 
80106ef8:	c7 80 9c 39 11 80 00 	movl   $0xcf9a00,-0x7feec664(%eax)
80106eff:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106f02:	c7 80 a0 39 11 80 ff 	movl   $0xffff,-0x7feec660(%eax)
80106f09:	ff 00 00 
80106f0c:	c7 80 a4 39 11 80 00 	movl   $0xcf9200,-0x7feec65c(%eax)
80106f13:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106f16:	c7 80 a8 39 11 80 ff 	movl   $0xffff,-0x7feec658(%eax)
80106f1d:	ff 00 00 
80106f20:	c7 80 ac 39 11 80 00 	movl   $0xcffa00,-0x7feec654(%eax)
80106f27:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106f2a:	c7 80 b0 39 11 80 ff 	movl   $0xffff,-0x7feec650(%eax)
80106f31:	ff 00 00 
80106f34:	c7 80 b4 39 11 80 00 	movl   $0xcff200,-0x7feec64c(%eax)
80106f3b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106f3e:	05 90 39 11 80       	add    $0x80113990,%eax
  pd[1] = (uint)p;
...
80106f64:	a1 c4 6d 11 80       	mov    0x80116dc4,%eax
...
80106fa8:	0f 84 c2 00 00 00    	je     80107070 <switchuvm+0xf0>
  pushcli();
80106fae:	e8 fd d8 ff ff       	call   801048b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106fb3:	e8 18 c9 ff ff       	call   801038d0 <mycpu>
80106fb8:	89 c3                	mov    %eax,%ebx
80106fba:	e8 11 c9 ff ff       	call   801038d0 <mycpu>
80106fbf:	89 c7                	mov    %eax,%edi
80106fc1:	e8 0a c9 ff ff       	call   801038d0 <mycpu>
80106fc6:	83 c7 08             	add    $0x8,%edi
80106fc9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106fcc:	e8 ff c8 ff ff       	call   801038d0 <mycpu>
...
801070af:	77 4b                	ja     801070fc <inituvm+0x6c>
  mem = kalloc();
801070b1:	e8 7a b5 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
...
801070c3:	e8 38 da ff ff       	call   80104b00 <memset>
...
801070f6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801070f7:	e9 a4 da ff ff       	jmp    80104ba0 <memmove>
    panic("inituvm: more than a page");
801070fc:	83 ec 0c             	sub    $0xc,%esp
801070ff:	68 65 7f 10 80       	push   $0x80107f65
...
8010722b:	e8 d0 d8 ff ff       	call   80104b00 <memset>
...
80107259:	76 48                	jbe    801072a3 <allocuvm+0xc3>
    mem = kalloc();
8010725b:	e8 d0 b3 ff ff       	call   80102630 <kalloc>
...
80107269:	68 9d 7f 10 80       	push   $0x80107f9d
...
801072cb:	68 b5 7f 10 80       	push   $0x80107fb5
...
801072f0:	e8 7b b1 ff ff       	call   80102470 <kfree>
      return 0;
...
8010738e:	e8 dd b0 ff ff       	call   80102470 <kfree>
...
801073a3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801073a4:	e9 c7 b0 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
801073a9:	83 ec 0c             	sub    $0xc,%esp
801073ac:	68 d1 7f 10 80       	push   $0x80107fd1
...
801073c9:	e8 62 b2 ff ff       	call   80102630 <kalloc>
...
801073e4:	e8 17 d7 ff ff       	call   80104b00 <memset>
...
8010744f:	a3 c4 6d 11 80       	mov    %eax,0x80116dc4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107483:	68 e2 7f 10 80       	push   $0x80107fe2
...
801074d0:	e8 cb d6 ff ff       	call   80104ba0 <memmove>
...
80107522:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107528:	e8 03 b1 ff ff       	call   80102630 <kalloc>
...
801075fe:	e8 9d d5 ff ff       	call   80104ba0 <memmove>
    len -= n;
    buf += n;
