...
_mutex_test:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  mutex_init(MUTEX);
  15:	6a 00                	push   $0x0
  17:	e8 1f 04 00 00       	call   43b <mutex_init>
  int pid = fork();
  1c:	e8 5a 03 00 00       	call   37b <fork>
  if(pid == 0){
  21:	83 c4 10             	add    $0x10,%esp
  24:	85 c0                	test   %eax,%eax
  26:	75 17                	jne    3f <main+0x3f>
    func_A(10);
  28:	83 ec 0c             	sub    $0xc,%esp
  2b:	6a 0a                	push   $0xa
  2d:	e8 1e 00 00 00       	call   50 <func_A>
  ...
  wait();
  35:	e8 51 03 00 00       	call   38b <wait>
  exit();
  3a:	e8 44 03 00 00       	call   383 <exit>
    func_B(15);
  3f:	83 ec 0c             	sub    $0xc,%esp
  42:	6a 0f                	push   $0xf
  44:	e8 67 00 00 00       	call   b0 <func_B>
...
int func_A(int n){
  ...
  5b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  5e:	eb 16                	jmp    76 <func_A+0x26>
  ...
  79:	6a 00                	push   $0x0
  7b:	e8 c3 03 00 00       	call   443 <mutex_acquire>
  if(n == 0){
  80:	83 c4 10             	add    $0x10,%esp
  83:	85 db                	test   %ebx,%ebx
  85:	75 d9                	jne    60 <func_A+0x10>
    printf(1, "func_A is done\n");
  87:	83 ec 08             	sub    $0x8,%esp
  8a:	68 78 08 00 00       	push   $0x878
  8f:	6a 01                	push   $0x1
  91:	e8 7a 04 00 00       	call   510 <printf>
    mutex_release(MUTEX);
  96:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  9d:	e8 a9 03 00 00       	call   44b <mutex_release>
}
...
int func_B(int n){
  ...
  bb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  be:	eb 16                	jmp    d6 <func_B+0x26>
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 d4 08 00 00 	movzbl 0x8d4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb ca 08 00 00       	mov    $0x8ca,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e5:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	a3 c4 0b 00 00       	mov    %eax,0xbc4
}
 737:	5e                   	pop    %esi
 738:	5f                   	pop    %edi
 739:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 77d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 780:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 c4 0b 00 00       	mov    0xbc4,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 c4 0b 00 00       	mov    %eax,0xbc4
}
 ...
 83e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 c4 0b 00 00 c8 	movl   $0xbc8,0xbc4
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf c8 0b 00 00       	mov    $0xbc8,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 862:	00 00 00 
    if(p->s.size >= nunits){
