...
_semaphore_test:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  15:	6a 01                	push   $0x1
  17:	6a 00                	push   $0x0
  19:	e8 55 04 00 00       	call   473 <sem_init>
  sem_init(FULL, BUFF_SIZE);
  1e:	58                   	pop    %eax
  1f:	5a                   	pop    %edx
  20:	6a 05                	push   $0x5
  22:	6a 01                	push   $0x1
  24:	e8 4a 04 00 00       	call   473 <sem_init>
  sem_init(EMPTY, BUFF_SIZE);
  29:	59                   	pop    %ecx
  2a:	58                   	pop    %eax
  2b:	6a 05                	push   $0x5
  2d:	6a 02                	push   $0x2
  2f:	e8 3f 04 00 00       	call   473 <sem_init>

  if (fork() == 0)
  34:	e8 92 03 00 00       	call   3cb <fork>
  39:	83 c4 10             	add    $0x10,%esp
  3c:	85 c0                	test   %eax,%eax
  3e:	75 0f                	jne    4f <main+0x4f>
    consumer();
  40:	e8 9b 00 00 00       	call   e0 <consumer>
  else
    producer();

  wait();
  45:	e8 91 03 00 00       	call   3db <wait>
  exit();
  4a:	e8 84 03 00 00       	call   3d3 <exit>
    producer();
  4f:	e8 0c 00 00 00       	call   60 <producer>
...
00000060 <producer>:
{
  ...
  68:	be cd cc cc cc       	mov    $0xcccccccd,%esi
{
  6d:	53                   	push   %ebx
  6e:	bb 14 00 00 00       	mov    $0x14,%ebx
  73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  77:	90                   	nop
    sem_acquire(EMPTY);
  78:	83 ec 0c             	sub    $0xc,%esp
  7b:	6a 02                	push   $0x2
  7d:	e8 f9 03 00 00       	call   47b <sem_acquire>
    sem_acquire(MUTEX);
  82:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  89:	e8 ed 03 00 00       	call   47b <sem_acquire>
    printf(1, "PRODUCER: wrote item %d to index %d\n", w_index, w_index % BUFF_SIZE);
  8e:	8b 0d 24 0c 00 00    	mov    0xc24,%ecx
  94:	89 c8                	mov    %ecx,%eax
  96:	f7 e6                	mul    %esi
  98:	89 d0                	mov    %edx,%eax
  9a:	83 e2 fc             	and    $0xfffffffc,%edx
  9d:	c1 e8 02             	shr    $0x2,%eax
  a0:	01 c2                	add    %eax,%edx
  a2:	89 c8                	mov    %ecx,%eax
  a4:	29 d0                	sub    %edx,%eax
  a6:	50                   	push   %eax
  a7:	51                   	push   %ecx
  a8:	68 c8 08 00 00       	push   $0x8c8
  ad:	6a 01                	push   $0x1
  af:	e8 ac 04 00 00       	call   560 <printf>
    sem_release(MUTEX);
  b4:	83 c4 14             	add    $0x14,%esp
  b7:	6a 00                	push   $0x0
  b9:	e8 c5 03 00 00       	call   483 <sem_release>
    sem_release(FULL);
  be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c5:	e8 b9 03 00 00       	call   483 <sem_release>
    w_index++;
  ca:	83 05 24 0c 00 00 01 	addl   $0x1,0xc24
  while (i < 20) {
  d1:	83 c4 10             	add    $0x10,%esp
  d4:	83 eb 01             	sub    $0x1,%ebx
  d7:	75 9f                	jne    78 <producer+0x18>
}
...
000000e0 <consumer>:
{
  ...
  e8:	be cd cc cc cc       	mov    $0xcccccccd,%esi
{
  ed:	53                   	push   %ebx
  ee:	bb 14 00 00 00       	mov    $0x14,%ebx
  f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  f7:	90                   	nop
    sleep(5);
  f8:	83 ec 0c             	sub    $0xc,%esp
  fb:	6a 05                	push   $0x5
  fd:	e8 61 03 00 00       	call   463 <sleep>
    sem_acquire(FULL);
 102:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 109:	e8 6d 03 00 00       	call   47b <sem_acquire>
    sem_acquire(MUTEX);
 10e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 115:	e8 61 03 00 00       	call   47b <sem_acquire>
    printf(1, "CONSUMER: read item %d from index %d\n", r_index, r_index % BUFF_SIZE);
 11a:	8b 0d 20 0c 00 00    	mov    0xc20,%ecx
 120:	89 c8                	mov    %ecx,%eax
 122:	f7 e6                	mul    %esi
 124:	89 d0                	mov    %edx,%eax
 126:	83 e2 fc             	and    $0xfffffffc,%edx
 129:	c1 e8 02             	shr    $0x2,%eax
 12c:	01 c2                	add    %eax,%edx
 12e:	89 c8                	mov    %ecx,%eax
 130:	29 d0                	sub    %edx,%eax
 132:	50                   	push   %eax
 133:	51                   	push   %ecx
 134:	68 f0 08 00 00       	push   $0x8f0
 139:	6a 01                	push   $0x1
 13b:	e8 20 04 00 00       	call   560 <printf>
    sem_release(MUTEX);
 140:	83 c4 14             	add    $0x14,%esp
 143:	6a 00                	push   $0x0
 145:	e8 39 03 00 00       	call   483 <sem_release>
    sem_release(EMPTY);
 14a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 151:	e8 2d 03 00 00       	call   483 <sem_release>
    r_index++;
 156:	83 05 20 0c 00 00 01 	addl   $0x1,0xc20
  while(i < 20) {
 15d:	83 c4 10             	add    $0x10,%esp
 160:	83 eb 01             	sub    $0x1,%ebx
 163:	75 93                	jne    f8 <consumer+0x18>
}
 165:	8d 65 f8             	lea    -0x8(%ebp),%esp
 168:	5b                   	pop    %ebx
 169:	5e                   	pop    %esi
 16a:	5d                   	pop    %ebp
 16b:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	eb 1a                	jmp    700 <printf+0x1a0>
          s = "(null)";
 6e6:	bb 16 09 00 00       	mov    $0x916,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 735:	a1 28 0c 00 00       	mov    0xc28,%eax
{
 ...
 756:	73 10                	jae    768 <free+0x38>
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	a3 28 0c 00 00       	mov    %eax,0xc28
}
 787:	5e                   	pop    %esi
 788:	5f                   	pop    %edi
 789:	5d                   	pop    %ebp
 ...
 7a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7aa:	a3 28 0c 00 00       	mov    %eax,0xc28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7d0:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 819:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 28 0c 00 00       	mov    0xc28,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 28 0c 00 00       	mov    %eax,0xc28
}
 ...
 88e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 28 0c 00 00 2c 	movl   $0xc2c,0xc28
 897:	0c 00 00 
    base.s.size = 0;
 89a:	bf 2c 0c 00 00       	mov    $0xc2c,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 2c 0c 00 00 2c 	movl   $0xc2c,0xc2c
 8a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8ab:	c7 05 30 0c 00 00 00 	movl   $0x0,0xc30
 8b2:	00 00 00 
    if(p->s.size >= nunits){
